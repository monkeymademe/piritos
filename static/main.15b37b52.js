...
parcelRequire.register("TeuAC", function(module, exports) {
...
$parcel$export(module.exports, "resolve", function () { return $0a60610db2d809a1$export$f7ad0328861e2f03; }, function (v) { return $0a60610db2d809a1$export$f7ad0328861e2f03 = v; });
var $0a60610db2d809a1$export$6503ec6e8aabbaf;
var $0a60610db2d809a1$export$f7ad0328861e2f03;
"use strict";
var $0a60610db2d809a1$var$mapping = {};
function $0a60610db2d809a1$var$register(pairs) {
    var keys = Object.keys(pairs);
    for(var i = 0; i < keys.length; i++)$0a60610db2d809a1$var$mapping[keys[i]] = pairs[keys[i]];
}
function $0a60610db2d809a1$var$resolve(id) {
    var resolved = $0a60610db2d809a1$var$mapping[id];
...
parcelRequire.register("k7Jmi", function(module, exports) {

module.exports = new URL("images/" + (parcelRequire("TeuAC")).resolve("jVuQl"), import.meta.url).toString();

});

parcelRequire.register("hvSrb", function(module, exports) {

module.exports = new URL("images/" + (parcelRequire("TeuAC")).resolve("80kVB"), import.meta.url).toString();

});

parcelRequire.register("kq8lU", function(module, exports) {

module.exports = new URL("images/" + (parcelRequire("TeuAC")).resolve("9iVEM"), import.meta.url).toString();

});

parcelRequire.register("aPWNK", function(module, exports) {

module.exports = new URL("images/" + (parcelRequire("TeuAC")).resolve("7JkUX"), import.meta.url).toString();

});

parcelRequire.register("1NCHx", function(module, exports) {

module.exports = new URL("images/" + (parcelRequire("TeuAC")).resolve("lfZIw"), import.meta.url).toString();

});

parcelRequire.register("baAvQ", function(module, exports) {

module.exports = new URL("images/" + (parcelRequire("TeuAC")).resolve("3y1yP"), import.meta.url).toString();

});

parcelRequire.register("cZmYF", function(module, exports) {

module.exports = new URL("images/" + (parcelRequire("TeuAC")).resolve("b04ra"), import.meta.url).toString();

});

parcelRequire.register("j3ZNH", function(module, exports) {

module.exports = new URL("images/" + (parcelRequire("TeuAC")).resolve("5n8Kq"), import.meta.url).toString();

});

var $65e78466d6c1d250$exports = {};

(parcelRequire("TeuAC")).register(JSON.parse('{"fkGbD":"main.15b37b52.js","kPKBf":"c804.df34a5a3.mp3","jG4vH":"c805.fe04160f.mp3","4C6fN":"c806.7471c895.mp3","ikrTT":"c807.7dbb1f94.mp3","5SvAR":"c811.193629bd.mp3","9eLvq":"c812.cec97ca8.mp3","fMR7n":"c813.6adaed39.mp3","disJZ":"c815.bf4e6816.mp3","cPeZT":"c816.983554c8.mp3","2sBbB":"c817a.0dc43017.mp3","lI1IL":"c817b.f15eeefd.mp3","8O2qp":"c824.b5843ba5.mp3","4Dg6Q":"c826.c92c5ee6.mp3","d98VB":"c829.ee19f85d.mp3","jgJWD":"powering_up.ebd58d74.mp3","3s93i":"powering_down.3cae8d9b.mp3","2MTlz":"redalert1a.02b04c25.mp3","iGZYO":"redalert2a.a124b93c.mp3","jVuQl":"jwst001.f6f4592c.jpg","80kVB":"jwst002.6d342356.jpg","9iVEM":"jwst003.b12533b0.jpg","7JkUX":"jwst004.57c7912b.jpg","lfZIw":"jwst005.9d03b451.jpg","3y1yP":"jwst006.3ea19dc6.jpg","b04ra":"jwst007.205e7180.jpg","5n8Kq":"jwst008.fc32dc4a.jpg"}'));

var $08b51f3f4a82ba06$export$2f0ee02dbc24ab6e;
var $08b51f3f4a82ba06$export$b1ee323202faff63;
var $08b51f3f4a82ba06$export$e252e9826f40ee5;
var $08b51f3f4a82ba06$export$d2eb0d710fd7e6a3;
var $08b51f3f4a82ba06$export$6bc1c44d5e100318;
var $08b51f3f4a82ba06$export$440642fd4c279c05;
function $08b51f3f4a82ba06$export$a13251365167ea49() {
    return Math.floor(Math.random() * 2) * 2 - 1;
}
function $08b51f3f4a82ba06$export$24d4d9f7cb1f68df(a, b) {
    if (b < a) [a, b] = [
        b,
        a
    ];
...
function $08b51f3f4a82ba06$export$7d15b64cf5a3a4c4(n, min = 0, max = 1) {
    return Math.min(max, Math.max(n, min));
}
function $08b51f3f4a82ba06$export$51e16a050e2bf069(a, b) {
    if (b < a) [a, b] = [
        b,
        a
    ];
...
function $08b51f3f4a82ba06$export$3c5f89dae98e900b(num = 2) {
    return Math.floor(Math.random() * num);
}
function $08b51f3f4a82ba06$export$cc4d98609e3a31e7(tmpMin = 1, tmpMax) {
    if (tmpMax == undefined) tmpMax = tmpMin;
    const tmpDigits = $08b51f3f4a82ba06$export$24d4d9f7cb1f68df(tmpMin, tmpMax); // first, randomly picks the number of digits the output will have
    return $08b51f3f4a82ba06$export$24d4d9f7cb1f68df(Math.pow(10, tmpDigits - 1), Math.pow(10, tmpDigits) - 1); // if tmpDigits=3, returns 100..999
}
function $08b51f3f4a82ba06$export$de12a21935b7f164(tmpArray) {
    if (!Array.isArray(tmpArray)) return "";
    if (tmpArray.length == 0) return "";
    return tmpArray[$08b51f3f4a82ba06$export$3c5f89dae98e900b(tmpArray.length)];
}
function $08b51f3f4a82ba06$export$dd918e842b943f50(n, width, char = 0) {
    n = n + "";
    return n.length >= width ? n : new Array(width - n.length + 1).join(char) + n;
}
function $08b51f3f4a82ba06$export$3c20c3b4fe44b7c5(tmpOdd = 0, tmpTotal = 1) {
    if (tmpTotal == 0) return false;
    if (Math.random() < tmpOdd / tmpTotal) return true;
    return false;
}
function $08b51f3f4a82ba06$export$61fc7d43ac8f84b0(callbackFunc, delay = 1000) {
    let timeout;
    return (...args)=>{
...
function $08b51f3f4a82ba06$export$de363e709c412c8a(callbackFunc, delay = 1000) {
...
function $08b51f3f4a82ba06$export$2af9aa02da5a4582(camelString) {
...
function $08b51f3f4a82ba06$export$275509f970718c8a(timerArray, functionRef, delay) {
    timerArray.push(setTimeout(functionRef, delay));
}
function $08b51f3f4a82ba06$export$9ffbd077477b35d(d3_element, singleClickFunc, doubleClickFunc, blocking = true, stopPropagation = true) {
...
function $08b51f3f4a82ba06$export$3640b375c01540b1(d3_element) {
    d3_element.on("pointerdown", null);
}
function $08b51f3f4a82ba06$export$1428f42a7de81803(hourType = "24hour", secondsType = "showSeconds") {
    ...
    let ss = "";
    if (secondsType === "showSeconds") ss = ":" + $08b51f3f4a82ba06$export$dd918e842b943f50(today.getSeconds(), 2);
    return $08b51f3f4a82ba06$export$dd918e842b943f50(hh, 2) + ":" + $08b51f3f4a82ba06$export$dd918e842b943f50(today.getMinutes(), 2) + ss;
}
function $08b51f3f4a82ba06$export$fedb369cb70207f1() {
...
function $08b51f3f4a82ba06$export$363474031fa64020() {
...
const $08b51f3f4a82ba06$var$greekLetters = [
    "ALPHA",
    "BETA",
    "GAMMA",
    "DELTA",
...
$08b51f3f4a82ba06$export$2f0ee02dbc24ab6e = $08b51f3f4a82ba06$var$greekLetters;
...
const $08b51f3f4a82ba06$var$constellationAbb = [
    "AND",
    "ANT",
    "APS",
    "AQR",
...
$08b51f3f4a82ba06$export$b1ee323202faff63 = $08b51f3f4a82ba06$var$constellationAbb;
const $08b51f3f4a82ba06$var$constellationName = [
    "Andromeda",
    "Antlia",
    "Apus",
    "Aquarius",
...
$08b51f3f4a82ba06$export$e252e9826f40ee5 = $08b51f3f4a82ba06$var$constellationName;
const $08b51f3f4a82ba06$var$warpRelatedShorterText = [
    "WF",
    "WARP",
    "POWER",
    "FIELD",
...
$08b51f3f4a82ba06$export$d2eb0d710fd7e6a3 = $08b51f3f4a82ba06$var$warpRelatedShorterText;
...
const $08b51f3f4a82ba06$var$warpRelatedLongText = [
    "WARP FACTOR",
...
$08b51f3f4a82ba06$export$6bc1c44d5e100318 = $08b51f3f4a82ba06$var$warpRelatedLongText;
const $08b51f3f4a82ba06$var$techRelatedLongText = [
    "STARFIELD 47",
    "INERTIA DAMPER",
    "SUBSPACE ANALYSIS",
    "GRAVITON MAPPING"
];
$08b51f3f4a82ba06$export$440642fd4c279c05 = $08b51f3f4a82ba06$var$techRelatedLongText; // BJS Animations ========================================================================================
 // const fps = 60;
 // exports.fps = fps;
 // const easeMode = {
...
const $067ccd90172917f4$var$numTurbolifts = 4; // zero index -- matching to svg turbolift id names. #turbolift0, #turbolift1, etc.
const $067ccd90172917f4$var$turbolifts = [];
const $067ccd90172917f4$var$turboliftLogging = false; // ! DEV <<<<<<<<<<<<<<<<<<<<<<<<
// sections and junctions are labeled in Figma
const $067ccd90172917f4$var$turboshaft = {};
$067ccd90172917f4$var$turboshaft.sections = [
    1,
    2,
    3,
    4,
...
$067ccd90172917f4$var$turboshaft.section1 = {
    doorX: [
        2577,
        2790,
        2969
...
$067ccd90172917f4$var$turboshaft.section2 = {
    doorX: [
        2539
    ],
    doorY: [
...
$067ccd90172917f4$var$turboshaft.section3 = {
    doorX: [
        2246,
        2350,
        2450,
...
$067ccd90172917f4$var$turboshaft.section4 = {
    doorX: [
        2223
    ],
    doorY: [
...
$067ccd90172917f4$var$turboshaft.section5 = {
    doorX: [
        2223,
        2033,
        1858
...
$067ccd90172917f4$var$turboshaft.section6 = {
    doorX: [
        906,
        1171,
        1446,
...
$067ccd90172917f4$var$turboshaft.section7 = {
    doorX: [
        963,
        1087,
        1126
...
$067ccd90172917f4$var$turboshaft.section8 = {
    doorX: [
        1126
    ],
    doorY: [
...
$067ccd90172917f4$var$turboshaft.junctions = {
    j1: {
        x: 2539,
        y: 134
    },
...
function $067ccd90172917f4$export$80d17a45d63df6f2() {
    for(let i = 0; i < $067ccd90172917f4$var$numTurbolifts; i++)$067ccd90172917f4$var$turbolifts[i].d3node.interrupt();
    if ($067ccd90172917f4$var$turboliftLogging) console.log("turbolift system stopped");
}
function $067ccd90172917f4$export$863452630d3a69f5(resetLocations = "resetLocations") {
    // ! if locations aren't reset, the immediate animations will look wonky
    if (resetLocations == "resetLocations") $067ccd90172917f4$var$turbolifts_setRandomLocations();
    for(let i = 0; i < $067ccd90172917f4$var$numTurbolifts; i++)$067ccd90172917f4$var$initTurbolift(i, "systemStarted");
    if ($067ccd90172917f4$var$turboliftLogging) console.log("turbolift system started");
}
function $067ccd90172917f4$export$22a41b0a1e33e61(force) {
    let toShow = force;
...
function $067ccd90172917f4$export$12ab491ecc4d1301() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    for(let i = 0; i < $067ccd90172917f4$var$numTurbolifts; i++)$067ccd90172917f4$var$turbolifts[i] = {
        d3node: d3.select(`#turbolift${i}`)
    };
    $067ccd90172917f4$var$turbolifts_setRandomLocations();
    if ($067ccd90172917f4$var$turboliftLogging) console.log("Turbolift System initiated");
}
function $067ccd90172917f4$var$turbolifts_setRandomLocations() {
    for(let i = 0; i < $067ccd90172917f4$var$numTurbolifts; i++){
        const newRandomCurrent = $067ccd90172917f4$var$randomTurboShaftSectionAndPoint();
        $067ccd90172917f4$var$turbolifts[i].currentSection = newRandomCurrent.section;
        $067ccd90172917f4$var$turbolifts[i].currentX = newRandomCurrent.x;
        $067ccd90172917f4$var$turbolifts[i].currentY = newRandomCurrent.y;
        // init svg turbolift position
        $067ccd90172917f4$var$turbolifts[i].d3node.attr("transform", `translate(${$067ccd90172917f4$var$turbolifts[i].currentX}, ${$067ccd90172917f4$var$turbolifts[i].currentY})`);
    }
}
/**
 ...
 */ function $067ccd90172917f4$var$initTurbolift(ti, systemStarted = null) {
    if (systemStarted !== "systemStarted") {
        $067ccd90172917f4$var$turbolifts[ti].currentSection = $067ccd90172917f4$var$turbolifts[ti].destSection;
        $067ccd90172917f4$var$turbolifts[ti].currentX = $067ccd90172917f4$var$turbolifts[ti].destX;
        $067ccd90172917f4$var$turbolifts[ti].currentY = $067ccd90172917f4$var$turbolifts[ti].destY;
    }
    // get a new random dest -- should be a different point from currentPoint, but could be the same section
    const randomDest = $067ccd90172917f4$var$randomTurboShaftSectionAndPoint($067ccd90172917f4$var$turbolifts[ti].currentX, $067ccd90172917f4$var$turbolifts[ti].currentY);
    $067ccd90172917f4$var$turbolifts[ti].destSection = randomDest.section;
    $067ccd90172917f4$var$turbolifts[ti].destX = randomDest.x;
    $067ccd90172917f4$var$turbolifts[ti].destY = randomDest.y;
    // store a temp array of junctions from currentSection to destSection
    const secFrom = $067ccd90172917f4$var$turbolifts[ti].currentSection;
    const secTo = $067ccd90172917f4$var$turbolifts[ti].destSection;
    $067ccd90172917f4$var$turbolifts[ti].junctions = [
        ...$067ccd90172917f4$var$turboshaft[`section${secFrom}`][`toSection${secTo}`]
    ];
    // set flag Complete to false
    $067ccd90172917f4$var$turbolifts[ti].destReached = false;
    $067ccd90172917f4$var$turbolifts[ti].prevJunction = null;
    $067ccd90172917f4$var$turbolifts[ti].nextJunction = null;
    $067ccd90172917f4$var$turboliftMove(ti);
}
/**
 * return a random section+point that is different from input point
 */ function $067ccd90172917f4$var$randomTurboShaftSectionAndPoint(inputX = 0, inputY = 0) {
    let generateNewRandom = true;
    let section, x, y;
    while(generateNewRandom){
        section = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)($067ccd90172917f4$var$turboshaft.sections);
        x = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)($067ccd90172917f4$var$turboshaft[`section${section}`].doorX);
        y = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)($067ccd90172917f4$var$turboshaft[`section${section}`].doorY);
 ...
 */ function $067ccd90172917f4$var$turboliftCheckProgress(tIndex) {
    if ($067ccd90172917f4$var$turbolifts[tIndex].destReached) {
        if ($067ccd90172917f4$var$turboliftLogging) console.log(`turbolift ${tIndex + 1}: destination reached`);
        // randomize the visibility of the human inside the turbolift ??
        $067ccd90172917f4$var$turbolifts[tIndex].d3node.transition().duration(600).attr("opacity", .5) // dest reached effect: slow blink
        .transition().duration(600).attr("opacity", 1).transition().delay((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(4000, 8000)) // idle a bit before new dest setup
        ...
        .transition().duration(100).attr("opacity", 1).transition().duration(100).attr("opacity", 0).transition().duration(100).attr("opacity", 1).on("end", ()=>{
            if ($067ccd90172917f4$var$turboliftLogging) console.log(`turbolift ${tIndex + 1}: new assignment. Moving...`);
            $067ccd90172917f4$var$initTurbolift(tIndex); // setup for new dest & move
        });
    } else $067ccd90172917f4$var$turboliftMove(tIndex);
}
/**
 * move the turbolift to its next junction or destination point
 * then invoke turboliftCheckProgress()
 * @param {*} ti turbolift index
 */ function $067ccd90172917f4$var$turboliftMove(ti) {
    const currentPos = $067ccd90172917f4$var$turbolifts[ti].d3node.attr("transform");
    let toX, toY;
    if ($067ccd90172917f4$var$turbolifts[ti].junctions.length != 0) {
        $067ccd90172917f4$var$turbolifts[ti].prevJunction = $067ccd90172917f4$var$turbolifts[ti].nextJunction;
        $067ccd90172917f4$var$turbolifts[ti].nextJunction = $067ccd90172917f4$var$turbolifts[ti].junctions.shift();
        toX = $067ccd90172917f4$var$turboshaft.junctions[$067ccd90172917f4$var$turbolifts[ti].nextJunction].x;
        toY = $067ccd90172917f4$var$turboshaft.junctions[$067ccd90172917f4$var$turbolifts[ti].nextJunction].y;
    } else {
        $067ccd90172917f4$var$turbolifts[ti].prevJunction = null;
        $067ccd90172917f4$var$turbolifts[ti].nextJunction = null;
        toX = $067ccd90172917f4$var$turbolifts[ti].destX;
        toY = $067ccd90172917f4$var$turbolifts[ti].destY;
        $067ccd90172917f4$var$turbolifts[ti].destReached = true;
    }
    if (($067ccd90172917f4$var$turbolifts[ti].prevJunction == "j7" || $067ccd90172917f4$var$turbolifts[ti].prevJunction == "j8") && ($067ccd90172917f4$var$turbolifts[ti].nextJunction == "j7" || $067ccd90172917f4$var$turbolifts[ti].nextJunction == "j8")) // ** Special case: msd turbolift "jump" from on graph area to area with quick fade effect
    $067ccd90172917f4$var$turbolifts[ti].d3node.transition().delay(300).duration(150).attr("opacity", 0).transition().duration(0).attr("transform", `translate(${toX},${toY})`).transition().duration(150).attr("opacity", 1).on("end", ()=>{
        $067ccd90172917f4$var$turboliftCheckProgress(ti);
    });
    else {
        let dur1 = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2500, 5000);
        if (($067ccd90172917f4$var$turbolifts[ti].prevJunction == "j8" || $067ccd90172917f4$var$turbolifts[ti].prevJunction == "j9") && ($067ccd90172917f4$var$turbolifts[ti].nextJunction == "j8" || $067ccd90172917f4$var$turbolifts[ti].nextJunction == "j9")) dur1 = 500;
        $067ccd90172917f4$var$turbolifts[ti].d3node.transition().delay((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(300, 600)).ease(d3.easeCubicInOut)// .ease(randomAItem[d3.easeExpIn, d3.easeExpOut, d3.easeExpInOut, d3.easeLinear])
        // .duration(1000)
...
var $f3cbaf88c79fc0d8$exports = {};

$f3cbaf88c79fc0d8$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("kPKBf"), import.meta.url).toString();


var $430e09dbeee53110$exports = {};

$430e09dbeee53110$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("jG4vH"), import.meta.url).toString();


var $a7e1598d0d4aa787$exports = {};

$a7e1598d0d4aa787$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("4C6fN"), import.meta.url).toString();


var $0439bec4571f578c$exports = {};

$0439bec4571f578c$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("ikrTT"), import.meta.url).toString();


var $a2ee9ae4ca10f84d$exports = {};

$a2ee9ae4ca10f84d$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("5SvAR"), import.meta.url).toString();


var $aed06003e2d06fda$exports = {};

$aed06003e2d06fda$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("9eLvq"), import.meta.url).toString();


var $3257c632557ea715$exports = {};

$3257c632557ea715$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("fMR7n"), import.meta.url).toString();


var $d2386b176d092825$exports = {};

$d2386b176d092825$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("disJZ"), import.meta.url).toString();


var $39e529066b5cf6ed$exports = {};

$39e529066b5cf6ed$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("cPeZT"), import.meta.url).toString();


var $86a0557149c2db34$exports = {};

$86a0557149c2db34$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("2sBbB"), import.meta.url).toString();


var $d6bd38c6abd9fa5c$exports = {};

$d6bd38c6abd9fa5c$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("lI1IL"), import.meta.url).toString();


var $2f24ba632eb93096$exports = {};

$2f24ba632eb93096$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("8O2qp"), import.meta.url).toString();


var $7258fc63344cf3c7$exports = {};

$7258fc63344cf3c7$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("4Dg6Q"), import.meta.url).toString();


var $9e3cb24727315b88$exports = {};

$9e3cb24727315b88$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("d98VB"), import.meta.url).toString();


var $6a3c8c41c282f57f$exports = {};

$6a3c8c41c282f57f$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("jgJWD"), import.meta.url).toString();


var $2df89a9d612f9a95$exports = {};

$2df89a9d612f9a95$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("3s93i"), import.meta.url).toString();


var $5d5e2c7b3a141e6c$exports = {};

$5d5e2c7b3a141e6c$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("2MTlz"), import.meta.url).toString();


var $4a3caf090b85b18d$exports = {};

$4a3caf090b85b18d$exports = new URL("sounds/" + (parcelRequire("TeuAC")).resolve("iGZYO"), import.meta.url).toString();


function $dab718e507db4475$export$3d7e390f2650e949() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    CRapp.sounds = {
    ...
    CRapp.resumeAudioContext = ()=>{
        ...
        if (CRapp.sounds.audioMainSwitch) $dab718e507db4475$var$setAudioMainOn();
    ...
    soundFxUrls.c804 = new URL($f3cbaf88c79fc0d8$exports);
    soundFxUrls.c805 = new URL($430e09dbeee53110$exports);
    soundFxUrls.c806 = new URL($a7e1598d0d4aa787$exports);
    soundFxUrls.c807 = new URL($0439bec4571f578c$exports);
    soundFxUrls.c811 = new URL($a2ee9ae4ca10f84d$exports); // ! rate =.8 lowTone warning
    soundFxUrls.c812 = new URL($aed06003e2d06fda$exports); // ! rate =.8 highTone warning; rate 1.08 sharp crisp beep  
    soundFxUrls.c813 = new URL($3257c632557ea715$exports); // ! rate =.8 lowTone double notification beeps
    soundFxUrls.c815 = new URL($d2386b176d092825$exports);
    soundFxUrls.c816 = new URL($39e529066b5cf6ed$exports);
    soundFxUrls.c817a = new URL($86a0557149c2db34$exports);
    soundFxUrls.c817b = new URL($d6bd38c6abd9fa5c$exports);
    soundFxUrls.c824 = new URL($2f24ba632eb93096$exports);
    soundFxUrls.c826 = new URL($7258fc63344cf3c7$exports);
    soundFxUrls.c829 = new URL($9e3cb24727315b88$exports); // ! rate =.8 lowTone multiBeep notification
    ...
    soundFxUrls.p001 = new URL($6a3c8c41c282f57f$exports);
    soundFxUrls.p002 = new URL($2df89a9d612f9a95$exports);
    // * red alert sounds
    soundFxUrls.alert01 = new URL($5d5e2c7b3a141e6c$exports);
    soundFxUrls.alert02 = new URL($4a3caf090b85b18d$exports);
    CRapp.sounds.redAlertTrackNames.push("alert01");
    CRapp.sounds.redAlertTrackNames.push("alert02");
    // pick a random alert sound to use
    CRapp.sounds.redAlertTrackNameCurrentIndex = (0, $08b51f3f4a82ba06$export$3c5f89dae98e900b)(CRapp.sounds.redAlertTrackNames.length);
    ...
    aboutIntroAudio.querySelector("span:first-child").addEventListener("pointerdown", (e)=>{
        $dab718e507db4475$export$c8cdacb776d3b001();
        e.stopPropagation();
    });
...
function $dab718e507db4475$export$c8cdacb776d3b001(force) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    if (CRapp.sounds.audioMainSwitch) {
        $dab718e507db4475$var$setAudioMainOn();
        if (document.documentElement.dataset.pageState == "init") $dab718e507db4475$export$80cb197f7ea4fe13("shortRandomBeep", 0, 0, 0, 0.65); // only for audio starting when app init
        else $dab718e507db4475$export$80cb197f7ea4fe13((0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "beepX1Up",
            "beepX1Upper",
            "beepX1Down",
            "beepX1Downer"
        ]), 0, 0, 0, 0.4);
        (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("Audio is now enabled");
    } else {
        $dab718e507db4475$var$setAudioMainOff();
        (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("Audio has been disabled");
    }
}
function $dab718e507db4475$var$setAudioMainOn() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
...
function $dab718e507db4475$var$setAudioMainOff() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
...
function $dab718e507db4475$export$521ad490824e86fd() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    return CRapp.sounds.sfxMasterGainNode.gain.value;
}
function $dab718e507db4475$export$6d762aca21a0d7bf(newValue) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    CRapp.sounds.sfxMasterGainNode.gain.value = newValue;
    CRapp.userSessionSettings.audioFxLevel = newValue;
}
function $dab718e507db4475$export$a4c58835879e53bb(audioBuffer, delay = 0, offset = 0, duration, volume = 1, playbackRate = 1) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
...
function $dab718e507db4475$export$80cb197f7ea4fe13(soundClipKey, delay = 0, offset = 0, duration, volume = 1, playbackRate = 1) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    if (duration == 0) duration = undefined;
    if (soundClipKey == "shortRandomBeep") {
        const newClip = CRapp.sounds.clips[(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "c811",
            "c812",
            "c813",
            "c829"
        ])];
        const newPlaybackRate = (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.93, 1.1);
        $dab718e507db4475$export$a4c58835879e53bb(newClip, delay, offset, duration, volume, newPlaybackRate * playbackRate);
    } else if (soundClipKey == "shortBeep") {
        const rndClip = (0, $08b51f3f4a82ba06$export$3c5f89dae98e900b)(7);
        if (rndClip == 1) {
            const newClip1 = CRapp.sounds.clips["c811"];
            $dab718e507db4475$export$a4c58835879e53bb(newClip1, 0.015, .155, duration, volume, playbackRate);
        } else if (rndClip == 2) {
            const newClip2 = CRapp.sounds.clips["c812"];
            $dab718e507db4475$export$a4c58835879e53bb(newClip2, 0.015, .143, duration, volume, playbackRate);
        } else if (rndClip == 3) {
            const newClip3 = CRapp.sounds.clips["c812"];
            $dab718e507db4475$export$a4c58835879e53bb(newClip3, 0.063, .146, duration, volume, playbackRate);
        } else if (rndClip == 4) {
            const newClip4 = CRapp.sounds.clips["c813"];
            $dab718e507db4475$export$a4c58835879e53bb(newClip4, 0.172, 0, duration, volume, playbackRate);
        } else if (rndClip == 5) {
            const newClip5 = CRapp.sounds.clips["c824"];
            $dab718e507db4475$export$a4c58835879e53bb(newClip5, 0, .266, duration, volume, playbackRate);
        } else if (rndClip == 6) {
            const newClip6 = CRapp.sounds.clips["c829"];
            $dab718e507db4475$export$a4c58835879e53bb(newClip6, 0, .172, duration, volume, playbackRate);
        } else {
            const newClip7 = CRapp.sounds.clips["c829"];
            $dab718e507db4475$export$a4c58835879e53bb(newClip7, 0, .115, duration, volume, playbackRate);
        }
    } else if (soundClipKey == "beepX1Up") {
        const newClip8 = CRapp.sounds.clips["c813"];
        const newPlaybackRate1 = (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(1.1, 1.3);
        $dab718e507db4475$export$a4c58835879e53bb(newClip8, delay, 0.08, 0.06, volume, newPlaybackRate1); // contains 1 beep
    } else if (soundClipKey == "beepX1Upper") {
        const newClip9 = CRapp.sounds.clips["c813"];
        const newPlaybackRate2 = (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(1.2, 1.5);
        $dab718e507db4475$export$a4c58835879e53bb(newClip9, delay, 0.08, 0.06, volume, newPlaybackRate2); // contains 1 beep
    } else if (soundClipKey == "beepX1Down") {
        const newClip10 = CRapp.sounds.clips["c813"];
        const newPlaybackRate3 = (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.65, .93);
        $dab718e507db4475$export$a4c58835879e53bb(newClip10, delay, 0.08, 0.06, volume, newPlaybackRate3); // contains 1 beep
    } else if (soundClipKey == "beepX1Downer") {
        const newClip11 = CRapp.sounds.clips["c813"];
        const newPlaybackRate4 = (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.5, .8);
        $dab718e507db4475$export$a4c58835879e53bb(newClip11, delay, 0.08, 0.06, volume, newPlaybackRate4); // contains 1 beep
    } else if (soundClipKey == "beepX2Up") {
        const newClip12 = CRapp.sounds.clips["c813"];
        const newPlaybackRate5 = (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(1.1, 1.3);
        $dab718e507db4475$export$a4c58835879e53bb(newClip12, delay, 0.08, 0.15, volume, newPlaybackRate5); // contains 2 beeps
    } else if (soundClipKey == "beepX2Upper") {
        const newClip13 = CRapp.sounds.clips["c813"];
        const newPlaybackRate6 = (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(1.2, 1.5);
        $dab718e507db4475$export$a4c58835879e53bb(newClip13, delay, 0.08, 0.15, volume, newPlaybackRate6); // contains 2 beeps
    } else if (soundClipKey == "beepX2Down") {
        const newClip14 = CRapp.sounds.clips["c813"];
        const newPlaybackRate7 = (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.85, .93);
        $dab718e507db4475$export$a4c58835879e53bb(newClip14, delay, 0.08, 0.15, volume, newPlaybackRate7); // contains 2 beeps
    } else if (soundClipKey == "beepX2Downer") {
        const newClip15 = CRapp.sounds.clips["c813"];
        const newPlaybackRate8 = (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.5, .8);
        $dab718e507db4475$export$a4c58835879e53bb(newClip15, delay, 0.08, 0.15, volume, newPlaybackRate8); // contains 2 beeps
    } else if (soundClipKey == "beepX3Up") {
        // 1st beep
        $dab718e507db4475$export$a4c58835879e53bb(CRapp.sounds.clips["c813"], delay, .08, .06, volume, playbackRate * (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.95, 1.1));
        // 2nd & 3rd beeps
        $dab718e507db4475$export$a4c58835879e53bb(CRapp.sounds.clips["c813"], delay + (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.09, .3), .08, .15, volume * (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.7, 1), playbackRate * (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(1.1, 1.3));
    } else if (soundClipKey == "beepX3Upper") {
        // 1st beep
        $dab718e507db4475$export$a4c58835879e53bb(CRapp.sounds.clips["c813"], delay, .08, .06, volume, playbackRate * (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(1.1, 1.3));
        // 2nd & 3rd beeps
        $dab718e507db4475$export$a4c58835879e53bb(CRapp.sounds.clips["c813"], delay + (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.09, .3), .08, .15, volume * (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.7, 1), playbackRate * (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(1.2, 1.5));
    } else if (soundClipKey == "beepX3Down") {
        // 1st beep
        $dab718e507db4475$export$a4c58835879e53bb(CRapp.sounds.clips["c813"], delay, .08, .06, volume, playbackRate * (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.93, 1));
        // 2nd & 3rd beeps
        $dab718e507db4475$export$a4c58835879e53bb(CRapp.sounds.clips["c813"], delay + 0.15, .08, .15, volume * 0.7, playbackRate * (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(0.85, 0.93));
    } else if (soundClipKey == "beepX3Downer") {
        // 1st beep
        $dab718e507db4475$export$a4c58835879e53bb(CRapp.sounds.clips["c813"], delay, .08, .06, volume, playbackRate * (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.85, .93));
        // 2nd & 3rd beeps
        $dab718e507db4475$export$a4c58835879e53bb(CRapp.sounds.clips["c813"], delay + 0.15, .08, .15, volume * 0.7, playbackRate * (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(0.5, 0.8));
    } else if (soundClipKey == "negative") {
        const newClip16 = CRapp.sounds.clips["c804"];
        const newPlaybackRate9 = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            .9,
            1,
            (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.85, 1)
        ]);
        $dab718e507db4475$export$a4c58835879e53bb(newClip16, delay, offset, duration, volume, newPlaybackRate9 * playbackRate);
    } else if (soundClipKey == "affirmative") {
        const newClip17 = CRapp.sounds.clips["c805"];
        const newPlaybackRate10 = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            .93,
            1.2,
            (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.95, 1)
        ]);
        $dab718e507db4475$export$a4c58835879e53bb(newClip17, delay, offset, duration, volume, newPlaybackRate10 * playbackRate);
    } else if (soundClipKey == "awaiting") {
        const newClip18 = CRapp.sounds.clips["c807"];
        const newPlaybackRate11 = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            .93,
            1.2,
            (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.95, 1)
        ]);
        $dab718e507db4475$export$a4c58835879e53bb(newClip18, delay, offset, duration, volume, newPlaybackRate11 * playbackRate);
    } else if (soundClipKey == "deployed") {
        const newClip19 = CRapp.sounds.clips["c816"];
        const newPlaybackRate12 = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            .95,
            1,
            (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.9, 1.2)
        ]);
        $dab718e507db4475$export$a4c58835879e53bb(newClip19, delay, offset, duration, volume, newPlaybackRate12 * playbackRate);
    } else if (soundClipKey == "executing") {
        const newClip20 = CRapp.sounds.clips["c817a"];
        const newPlaybackRate13 = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            .93,
            1.2,
            (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.95, 1)
        ]);
        $dab718e507db4475$export$a4c58835879e53bb(newClip20, delay, offset, duration, volume, newPlaybackRate13 * playbackRate);
    } else if (soundClipKey == "processing") {
        const newClip21 = CRapp.sounds.clips["c826"];
        const newPlaybackRate14 = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            .93,
            1,
            (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.8, 1.2)
        ]);
        $dab718e507db4475$export$a4c58835879e53bb(newClip21, delay, offset, duration, volume, newPlaybackRate14 * playbackRate);
    } else if (soundClipKey == "warningLow") {
        const newClip22 = CRapp.sounds.clips["c811"];
        const newPlaybackRate15 = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            .75,
            .85
        ]);
        $dab718e507db4475$export$a4c58835879e53bb(newClip22, delay, offset, duration, volume, newPlaybackRate15 * playbackRate);
    } else if (soundClipKey == "warningHigh") {
        const newClip23 = CRapp.sounds.clips["c812"];
        const newPlaybackRate16 = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            .75,
            .85
        ]);
        $dab718e507db4475$export$a4c58835879e53bb(newClip23, delay, offset, duration, volume, newPlaybackRate16 * playbackRate);
    } else if (soundClipKey == "warningLong") {
        const newClip24 = CRapp.sounds.clips["c817b"];
        const newPlaybackRate17 = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            .88,
            .94,
            1
        ]);
        $dab718e507db4475$export$a4c58835879e53bb(newClip24, delay, offset, duration, volume, newPlaybackRate17 * playbackRate);
    } else if (soundClipKey == "notification") {
        const newClip25 = CRapp.sounds.clips[(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "c813",
            "c829"
        ])];
        const newPlaybackRate18 = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            .8,
            .85
        ]);
        $dab718e507db4475$export$a4c58835879e53bb(newClip25, delay, offset, duration, volume, newPlaybackRate18 * playbackRate);
    } else if (soundClipKey == "exitTask") {
        const newClip26 = CRapp.sounds.clips["c815"];
        const newPlaybackRate19 = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            1,
            (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.95, 1.1)
        ]);
        $dab718e507db4475$export$a4c58835879e53bb(newClip26, delay, offset, duration, volume, newPlaybackRate19 * playbackRate);
    } else if (soundClipKey == "lowProfileTask") {
        const newClip27 = CRapp.sounds.clips["c806"];
        const newPlaybackRate20 = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            1,
            (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.95, 1.1)
        ]);
        $dab718e507db4475$export$a4c58835879e53bb(newClip27, delay, offset, duration, volume, newPlaybackRate20 * playbackRate);
    } else if (soundClipKey == "longTask") {
        const newClip28 = CRapp.sounds.clips["c806"];
        const newPlaybackRate21 = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            .93,
            1
        ]);
        $dab718e507db4475$export$a4c58835879e53bb(newClip28, delay, offset, duration, volume, newPlaybackRate21 * playbackRate);
    } else if (soundClipKey == "longTaskLow") {
        const newClip29 = CRapp.sounds.clips["c806"];
        const newPlaybackRate22 = (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.78, .85);
        $dab718e507db4475$export$a4c58835879e53bb(newClip29, delay, offset, duration, volume, newPlaybackRate22 * playbackRate);
    } else if (soundClipKey == "powerUp") {
        const newClip30 = CRapp.sounds.clips["p001"];
        $dab718e507db4475$export$a4c58835879e53bb(newClip30, delay, offset, duration, volume, playbackRate);
    } else if (soundClipKey == "powerDown") {
        const newClip31 = CRapp.sounds.clips["p002"];
        $dab718e507db4475$export$a4c58835879e53bb(newClip31, delay, offset, duration, volume, playbackRate);
    } else if (soundClipKey == "startRedAlert") {
        if (CRapp.sounds.redAlertTrackNode != null) $dab718e507db4475$export$80cb197f7ea4fe13("stopRedAlert"); // make sure previous alert has stopped
        $dab718e507db4475$export$80cb197f7ea4fe13("warningLong");
        $dab718e507db4475$export$80cb197f7ea4fe13("executing", 1);
        ...
        CRapp.sounds.redAlertTrackNode = $dab718e507db4475$export$a4c58835879e53bb(newClip32, 2.3, offset, duration, volume, playbackRate);
        ...
        $dab718e507db4475$export$80cb197f7ea4fe13("exitTask", 0.25, 0, 0, 0.6, 0.9);
    } else if (soundClipKey in CRapp.sounds.clips) {
        const newClip33 = CRapp.sounds.clips[soundClipKey];
        $dab718e507db4475$export$a4c58835879e53bb(newClip33, delay, offset, duration, volume, playbackRate);
    }
}


function $6fdf0ffb4a84c329$export$43d4f9696d93e7dd() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    // =================== set up ship zooming
    ...
    (0, $ba5c5d811afd797b$export$5f3b35c2b8474baf)(CRapp.shipRef.shipD3.node()); // special zoom (saucer, eng, nacelle) will use this reference data
    ...
    CRapp.shipContentDom.querySelector("#hitareas").onpointerdown = (e)=>{
        ...
        // if labels are visible & there's corresponding label, do label effect
        if ((0, $fb2f4fe51f80d60c$export$54007cc6d00f8c3a)(e.target) === false) $6fdf0ffb4a84c329$export$b9bb69d98eff82dd(e.target);
    };
    ...
    (0, $ba5c5d811afd797b$export$5f3b35c2b8474baf)(wires);
    ...
    CRapp.shipContentDom.querySelector("#wcHatchHitspot").onpointerdown = function() {
        $6fdf0ffb4a84c329$var$warpCoreEjectAnimation();
    };
}
function $6fdf0ffb4a84c329$export$203cdef525f5b26e() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    if (currentZoomInObjId !== undefined && Math.random() < 0.2) {
        $6fdf0ffb4a84c329$export$867e02d6ef0e904();
        return;
    }
    // * pick a another random object to zoom in to
    const objList = document.querySelectorAll("#msdContainer svg #ship #hitareas > *");
    let randomIndex = (0, $08b51f3f4a82ba06$export$3c5f89dae98e900b)(objList.length);
    ...
    $6fdf0ffb4a84c329$export$b9bb69d98eff82dd(randomObj);
}
function $6fdf0ffb4a84c329$export$867e02d6ef0e904() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    const shipD3 = CRapp.shipRef.shipD3;
    const currentZoomInObjId = shipD3.node().dataset.zoomObj;
    if (currentZoomInObjId !== undefined) {
        ...
        $6fdf0ffb4a84c329$export$b9bb69d98eff82dd(currentZoomInObj);
    } else {
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("longTaskLow", 0, 0, 0, 0.3);
        if (Math.random() < 0.5) (0, $dab718e507db4475$export$80cb197f7ea4fe13)("shortRandomBeep", 0.5, 0, 0, 0.25);
        else (0, $dab718e507db4475$export$80cb197f7ea4fe13)(`beepX${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 3)}${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "Down",
            "Downer",
            "Up",
            "Upper"
        ...
        const rndWidth = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            0,
            1,
            2,
            4,
        ...
        const rndOpacity = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            0,
            0.3,
            0.6,
            1,
        ...
        const rndColor = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)(CRapp.nonDarkColorCssVarNames);
        ...
        d3.select(contentShip).transition().duration(600).ease(d3.easeCubicOut).style("transform", `${tta} scale(1.037) ${ttb}`).on("end", ()=>{
            (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(document.querySelector(`#msdContainer svg #ship #outlines`));
...
function $6fdf0ffb4a84c329$export$71d9d5af3ae909a7() {
...
function $6fdf0ffb4a84c329$export$b9bb69d98eff82dd(domObj) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    // =================== set up ship zooming
    //* Don't apply transform to SVG element's 'transform' attribute. Firefox doesn't apply css transition animation on this attribute.
    //* Instead, apply transform changes to 'style' attribute
    ...
    const previousZoomScale = shipD3.node().dataset.zoomScale ?? 1;
    const previousZoomTranslate = shipD3.node().dataset.zoomTranslate ?? "0,0";
    // console.log('previousZoomScale = ' + previousZoomScale);
    // console.log('zoomObj ID = ' + domObjId);
    // pauseSvgRootAnimation();
    $6fdf0ffb4a84c329$export$8a2e6fed9df8c3ad("forZooming"); //* <<<<<<< &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
    delete document.documentElement.dataset.shipZoomObj;
    if (previousZoomObj == domObjId) {
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)((0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "beepX1Upper",
            "beepX2Down",
            "beepX3Downer"
        ]), 0, 0, 0, 0.3);
        ...
        .transition().delay(300).duration(1).on("start", ()=>{
            ...
            $6fdf0ffb4a84c329$export$f254544244e1cd1a("forZooming"); //* <<<<<<< &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
            if (shipD3.node().dataset.showLabelsOnZoomOut == "show") (0, $fb2f4fe51f80d60c$export$8baee8e71bc8bf1)("faster");
            CRapp.shipZoomMode = false;
            delete document.documentElement.dataset.shipZoomMode; // for ani final state
        });
        (0, $ba5c5d811afd797b$export$fa6d0396531d5260)();
        return; // ! <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< break point
    } else {
        ...
        if (previousZoomObj != undefined) scaleDelay = scaleDelayShort; // ! shorter delay between change of translate & scale while already Zoomed in
            ...
            if (shipD3.node().dataset.labelsHideDelay == "delay") {
                ...
                setTimeout(()=>{
                    (0, $fb2f4fe51f80d60c$export$9366dc6771d56232)("skipAnimation");
                }, 1000);
            } else (0, $fb2f4fe51f80d60c$export$9366dc6771d56232)("skipAnimation");
        }
        let titleText = (0, $08b51f3f4a82ba06$export$2af9aa02da5a4582)(domObjId.replace(/[^_]*_(.*)/g, "$1") // removing hitarea id's prefix of 'hit_' 
        ).toUpperCase();
        ...
        (0, $ba5c5d811afd797b$export$fa6d0396531d5260)(titleText);
    ...
    (0, $dab718e507db4475$export$80cb197f7ea4fe13)(`beepX${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 3)}${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
        "Down",
        "Downer",
        "Up",
        "Upper"
    ])}`, 0, 0, 0, 0.45);
    if (Math.random() < 0.5 && previousZoomObj == undefined) (0, $dab718e507db4475$export$80cb197f7ea4fe13)(`beepX${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 3)}${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
        "Down",
        "Downer",
        "Up",
        "Upper"
    ...
    .on("start", ()=>{
        ...
        if (previousZoomObj == undefined) {
            ...
            if (tmpStyle < .5) (0, $dab718e507db4475$export$80cb197f7ea4fe13)((0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                "processing",
                "executing"
            ]), 0, 0.1, 0.4, 0.3, 0.8);
            else if (tmpStyle < .75) (0, $dab718e507db4475$export$80cb197f7ea4fe13)("longTask", 0, 0.8, 0, 0.3, 1.2);
            else (0, $dab718e507db4475$export$80cb197f7ea4fe13)("notification", 0, 0, 0, 0.3);
        }
    }).on("end", ()=>{
        if (previousZoomObj != undefined) (0, $dab718e507db4475$export$80cb197f7ea4fe13)(`beepX${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "1",
            "1",
            "2"
        ])}${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "Down",
            "Downer",
            "Up",
            "Upper"
...
function $6fdf0ffb4a84c329$export$e5252ff02fc9962b(d3node, initDelayTime = 0, iterations = 1, iterationInterval = "short", initIterationFlag = true) {
    if (iterations == 0) return;
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    let delayTime = initDelayTime;
    if (!initIterationFlag) {
        if (iterationInterval == "short") delayTime = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(200, 600);
        else if (typeof iterationInterval === "number") delayTime = Math.floor((0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(iterationInterval * .7, iterationInterval * 1.3));
        else delayTime = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(800, 1200);
    }
    d3node.transition("randomColor").delay(delayTime).duration(1).attr("fill", `var(--${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)(CRapp.allColorCssVarNames)})`).on("end", ()=>{
        const newIteration = iterations > 0 ? iterations - 1 : iterations;
        $6fdf0ffb4a84c329$export$e5252ff02fc9962b(d3node, 0, newIteration, iterationInterval, false);
    });
}
function $6fdf0ffb4a84c329$export$8d9eb7bfa1fb6cf8(d3node) {
    d3node.interrupt("randomColor"); // this will 'interrupt' current transition, AND 'cancel' pending transition
}
function $6fdf0ffb4a84c329$export$6a08326b8e10c7e4(d3node, initDelayTime = 0, iterations = 1, iterationInterval = "short", initIterationFlag = true) {
    if (iterations == 0) return;
    let delayTime = initDelayTime;
    if (!initIterationFlag) {
        if (iterationInterval == "short") delayTime = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(200, 600);
        else if (typeof iterationInterval === "number") delayTime = Math.floor((0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(iterationInterval * .7, iterationInterval * 1.3));
        else delayTime = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2000, 3000);
    ...
    d3node.transition("blinking").delay(delayTime).duration(500).attr("opacity", 0).on("cancel interrupt", ()=>{
        ...
        const newIteration = iterations > 0 ? iterations - 1 : iterations;
        $6fdf0ffb4a84c329$export$6a08326b8e10c7e4(d3node, 0, newIteration, iterationInterval, false);
    });
}
function $6fdf0ffb4a84c329$export$2447af625794f715(d3node) {
    d3node.interrupt("blinking"); // this will 'interrupt' current transition, AND 'cancel' pending transition
}
function $6fdf0ffb4a84c329$var$warpCoreEjectAnimation() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    if ("ejectionInProgress" in warpCore.dataset) {
        (0, $ba5c5d811afd797b$export$915e86dc1242cd73)((0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
    ...
    (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("Warp Core Ejection in Progress", "timePrefix");
    ...
    d3.select(warpCore).style("opacity", 3).transition().duration(500).on("start", ()=>{
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("warningLong", 0, 0.4, 0, 0.6);
        (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(warpCore, "blink3");
    }).on("end", ()=>{
        ...
        //* open hatch
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("notification", 0.25);
    ...
    .style("opacity", 0).on("start", ()=>{
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("negative", 0.2, 0, 0, 1, 0.85);
        ...
        setTimeout(()=>{
            (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("Warp Core Ejected", "timePrefix");
        }, 1200);
    }).on("end", ()=>{
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("awaiting", 0.3, 0, 0, 0.5, .75);
        ...
        setTimeout(()=>{
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("exitTask", 0, 0, 0, 0.7); //* warpCore almost being reattached
            //* closing hatch
            wcHatch.transition().delay(500).duration(1000).ease(d3.easeCubicInOut).attr("transform", "translate(0 0)").on("start", (d, i)=>{
                if (i == 0) (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Downer", 0.4, 0, 0, 0.3);
            });
        }, 4500);
    ...
    .on("end", ()=>{
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("powerUp", 0, 0.3, 0, 0.7);
    }).transition().delay(600).duration(250).on("start", ()=>{
        //* restart warpCore
        (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(warpCore, "blink1");
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX3Upper", 0, 0, 0, 0.3);
    }).on("end", function() {
...
function $6fdf0ffb4a84c329$export$f254544244e1cd1a(forZooming = null) {
    ...
    if (!zooming) {
        ...
        (0, $067ccd90172917f4$export$863452630d3a69f5)();
        $6fdf0ffb4a84c329$export$8d457bddbb9682c2();
        $6fdf0ffb4a84c329$export$30bf6a931e8558b6();
        $6fdf0ffb4a84c329$export$e650195b962e32f();
        $6fdf0ffb4a84c329$var$shuttleLiftAnimation_start();
    }
    $6fdf0ffb4a84c329$export$f12be6b3055d7000(true);
    $6fdf0ffb4a84c329$export$390b2b428a870f7a();
    $6fdf0ffb4a84c329$export$287f8a7b62d6b86();
    $6fdf0ffb4a84c329$export$2e57723d70271d97();
    $6fdf0ffb4a84c329$export$b9e2f45ec1738f00();
    $6fdf0ffb4a84c329$export$3bc1210f46ea5e87();
// console.log('ship mini animations started');
}
function $6fdf0ffb4a84c329$export$8a2e6fed9df8c3ad(forZooming = null) {
    const zooming = forZooming == "forZooming";
    ...
    if (!zooming) {
        ...
        (0, $067ccd90172917f4$export$80d17a45d63df6f2)();
        $6fdf0ffb4a84c329$var$holodeckAnimation_stop();
        $6fdf0ffb4a84c329$var$transporterAnimation_stop();
        $6fdf0ffb4a84c329$var$shuttlecraftFlyingAnimation_stop();
        $6fdf0ffb4a84c329$var$shuttleLiftAnimation_stop();
    }
    $6fdf0ffb4a84c329$export$f12be6b3055d7000(false);
    $6fdf0ffb4a84c329$export$428c8513657fadbd();
    $6fdf0ffb4a84c329$export$e208cb55376d1d4b();
    $6fdf0ffb4a84c329$export$6042103286502b70();
    $6fdf0ffb4a84c329$export$7736dcfecdbe14bc();
    $6fdf0ffb4a84c329$export$26005a9ab81e8a26();
// console.log('ship mini animations stopped');
}
function $6fdf0ffb4a84c329$export$26005a9ab81e8a26() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    CRapp.svg1.pauseAnimations(); // SVG root's built in function
}
function $6fdf0ffb4a84c329$export$3bc1210f46ea5e87() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    CRapp.svg1.unpauseAnimations(); // SVG root's built in function
}
function $6fdf0ffb4a84c329$export$fcfbdb67292ec4e5() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
...
function $6fdf0ffb4a84c329$export$8d457bddbb9682c2() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    const holodeck = CRapp.shipContentDom.querySelector("#holodeck"); // ! DOM obj
    ...
    let holoTitleIndex = (0, $08b51f3f4a82ba06$export$3c5f89dae98e900b)(holoTitles.length);
    ...
    .on("end", function() {
        ...
        .on("start", ()=>{
            if (holoMovie) holoObject.selectAll("[id^=seq_]").style("transition", ()=>{
                return `opacity ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                    300,
                    700
                ])}ms ease ${100 * (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(0, 30)}ms`;
            }) // delay 0 to 3000ms
            .attr("opacity", 1);
        }).on("end", function() {
                ...
                .on("start", ()=>{
                    ...
                    .on("end", ()=>{
                        holodeck.dataset.timerId = setTimeout(()=>{
                            $6fdf0ffb4a84c329$export$8d457bddbb9682c2(); // wait, then starting all over again
                        }, (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(5800, 9500));
                    });
                });
            });
        });
...
function $6fdf0ffb4a84c329$var$holodeckAnimation_stop() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    const holodeck = CRapp.shipContentDom.querySelector("#holodeck"); // ! DOM obj
    const timerId = Number(holodeck.dataset.timerId);
    if (!isNaN(timerId)) clearTimeout(timerId);
    d3.selectAll("#msdContainer svg #holodeck *").interrupt(); // dirty cleaning...
    $6fdf0ffb4a84c329$export$fcfbdb67292ec4e5();
}
function $6fdf0ffb4a84c329$export$30bf6a931e8558b6(init = null) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    d3.selectAll("#msdContainer svg #transporterBeam1 line").style("stroke-dashoffset", ()=>{
        return (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(-10, -45);
    }).style("animation-duration", ()=>{
        return (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(3.5, 4.5) + "s";
    });
    const showBeam1 = ()=>{
    ...
    subject1.transition().delay((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(6000, 12000)).duration(0).on("start", ()=>{
        showBeam1();
    }).transition().delay(2000).duration(0).attr("opacity", 0) // hiding subject
    .transition().delay((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(6000, 12000)).duration(0) // long delay
    .on("start", ()=>{
...
function $6fdf0ffb4a84c329$var$transporterAnimation_stop() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    d3.select(CRapp.shipContentDom.querySelector("#transporterSubject1")).interrupt();
}
//? ======================================================================================
//? ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
function $6fdf0ffb4a84c329$var$shuttlecraftFlyingAnimation_init(startFlying = null) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    animateMotionNode.setAttribute("begin", `-${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(0, 30)}s`); // use negative value to vary the starting position along the path
...
//? ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
//? ======================================================================================
function $6fdf0ffb4a84c329$var$shuttleLiftAnimation_start() {
    $6fdf0ffb4a84c329$export$a390aa51a0f87c5d("init");
}
function $6fdf0ffb4a84c329$var$shuttleLiftAnimation_stop() {
...
function $6fdf0ffb4a84c329$export$a390aa51a0f87c5d(init = null) {
    const shuttle = d3.select("#msdContainer svg #shuttleOnLift");
    const shuttleLift = d3.select("#msdContainer svg #shuttleLift");
    ...
    const durShuttleLiftUp = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(3000, 6000);
    const durShuttleLiftDown = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(3000, 5000);
    shuttleLift.transition().delay((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1000, 2000)).duration(durShuttleLiftUp) // slow going up
    ...
    }).transition().delay((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(200, 500)) // short delay before moving DOWN the lift
    .duration((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1000, 4000)) // random dur
    .ease(d3.easeCubicInOut).attr("transform", "translate(0 44)").transition().delay((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2500, 6000)) // long delay before moving UP the lift
    .duration((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1000, 4000)) // random dur
    .ease(d3.easeCubicInOut).attr("transform", "translate(0 0)").transition().delay((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(300, 700)) // short delay before moving DOWN the lift
    ...
    .ease(d3.easeCubicInOut).attr("transform", "translate(0 44)").on("start", ()=>{
        ...
        shuttle.transition().duration(durShuttleLiftDown).ease(d3.easeCubicInOut).attr("transform", "translate(0 44)").on("end", ()=>{
            ...
            $6fdf0ffb4a84c329$export$e5252ff02fc9962b(shuttle.select("path"), 400, 4);
        // shuttle.select('path')
        // .transition()
        ...
        shuttleLift.node().dataset.timerId = setTimeout(()=>{
            $6fdf0ffb4a84c329$export$a390aa51a0f87c5d(); // wait, then starting all over again
        }, (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(2500, 6000));
    });
}
function $6fdf0ffb4a84c329$export$390b2b428a870f7a() {
    ...
    if (plasmaStream.attr("data-init") == null) {
        ...
        plasmaStream.selectAll("line").attr("stroke-dashoffset", ()=>{
            return (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(-100, 0);
        }).style("animation-duration", ()=>{
            return (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(3, 6) + "s";
        });
    ...
    const plasmaAnimationCycle = function() {
        ...
        .ease(d3.easeCubicIn).attr("transform", "translate(-242) scale(6 .3)").on("start", ()=>{
            ...
            }).transition().delay((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(800, 1600)) // random delay time before dispatching the cycle again
...
function $6fdf0ffb4a84c329$export$428c8513657fadbd() {
    const plasmaStream = d3.select("#msdContainer svg #plasmaStream");
    const receiver = d3.select("#msdContainer svg #cylinderFront");
...
function $6fdf0ffb4a84c329$export$287f8a7b62d6b86() {
    $6fdf0ffb4a84c329$export$e5252ff02fc9962b(d3.select("#msdContainer svg #magFieldGen"), (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(3500, 7000), -1, 5000); //                           ^^^ with specific settings
}
function $6fdf0ffb4a84c329$export$e208cb55376d1d4b() {
    $6fdf0ffb4a84c329$export$8d9eb7bfa1fb6cf8(d3.select("#msdContainer svg #magFieldGen"));
}
function $6fdf0ffb4a84c329$export$2e57723d70271d97() {
    const d3node = d3.select("#msdContainer svg #bussardProcessor");
    $6fdf0ffb4a84c329$export$6a08326b8e10c7e4(d3node, (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(5000, 7000), -1, 5000);
    $6fdf0ffb4a84c329$export$e5252ff02fc9962b(d3node, (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(3500, 7000), -1, 13000);
//                                           ^^^ with specific settings
}
function $6fdf0ffb4a84c329$export$6042103286502b70() {
    const d3node = d3.select("#msdContainer svg #bussardProcessor");
    $6fdf0ffb4a84c329$export$2447af625794f715(d3node);
    $6fdf0ffb4a84c329$export$8d9eb7bfa1fb6cf8(d3node);
}
function $6fdf0ffb4a84c329$export$f12be6b3055d7000(force) {
...
function $6fdf0ffb4a84c329$export$b9e2f45ec1738f00() {
    // console.log('!!!!! STARTING ship misc animations ------>>>');
    const shipInternalsD3 = d3.select("#msdContainer svg #contentShip #internals");
    $6fdf0ffb4a84c329$export$e5252ff02fc9962b(shipInternalsD3.select("#shuttle1 path"), (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(3500, 7000), -1, 13000);
    $6fdf0ffb4a84c329$export$e5252ff02fc9962b(shipInternalsD3.select("#bay2shuttle1 path"), (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(5000, 11000), -1, 13000);
    $6fdf0ffb4a84c329$export$e5252ff02fc9962b(shipInternalsD3.select("#bay2shuttle2 path"), (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2000, 5000), -1, 9000);
    $6fdf0ffb4a84c329$export$e5252ff02fc9962b(shipInternalsD3.select("#torpedoLauncher"), (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2000, 5000), -1, 9000);
    $6fdf0ffb4a84c329$export$e5252ff02fc9962b(shipInternalsD3.select("#bridge"), (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2000, 5000), -1, 9000);
    $6fdf0ffb4a84c329$export$e5252ff02fc9962b(shipInternalsD3.select("#transporterBase"), (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2000, 5000), -1, 9000);
    $6fdf0ffb4a84c329$export$e5252ff02fc9962b(shipInternalsD3.select("#transporterMid"), (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2000, 5000), -1, 9000);
    $6fdf0ffb4a84c329$export$6a08326b8e10c7e4(shipInternalsD3.select("#deuteriumTank1"), (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2000, 8000), -1, 11000);
    $6fdf0ffb4a84c329$export$6a08326b8e10c7e4(shipInternalsD3.select("#deuteriumTank2"), (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2000, 8000), -1, 11000);
    $6fdf0ffb4a84c329$export$6a08326b8e10c7e4(shipInternalsD3.select("#antimatterStorage"), (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(4000, 5000), -1, 12000);
    $6fdf0ffb4a84c329$export$6a08326b8e10c7e4(shipInternalsD3.select("#tractorBeamMainForward"), (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2000, 8000), -1, 8000);
    $6fdf0ffb4a84c329$export$6a08326b8e10c7e4(shipInternalsD3.select("#tractorBeamMainAft"), (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2000, 8000), -1, 8000);
    $6fdf0ffb4a84c329$export$6a08326b8e10c7e4(shipInternalsD3.select("#tractorBeam2ndHull"), (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2000, 8000), -1, 8000);
    $6fdf0ffb4a84c329$export$6a08326b8e10c7e4(shipInternalsD3.select("#tardis"), (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2000, 8000), -1, 8000);
}
function $6fdf0ffb4a84c329$export$7736dcfecdbe14bc() {
    // console.log('!!!!! STOPPING ship misc animations X X X X X X X X X X X ');
    const shipInternalsD3 = d3.select("#msdContainer svg #contentShip #internals");
    $6fdf0ffb4a84c329$export$8d9eb7bfa1fb6cf8(shipInternalsD3.select("#shuttle1 path"));
    $6fdf0ffb4a84c329$export$8d9eb7bfa1fb6cf8(shipInternalsD3.select("#bay2shuttle1 path"));
    $6fdf0ffb4a84c329$export$8d9eb7bfa1fb6cf8(shipInternalsD3.select("#bay2shuttle2 path"));
    $6fdf0ffb4a84c329$export$8d9eb7bfa1fb6cf8(shipInternalsD3.select("#torpedoLauncher"));
    $6fdf0ffb4a84c329$export$8d9eb7bfa1fb6cf8(shipInternalsD3.select("#bridge"));
    $6fdf0ffb4a84c329$export$8d9eb7bfa1fb6cf8(shipInternalsD3.select("#transporterBase"));
    $6fdf0ffb4a84c329$export$8d9eb7bfa1fb6cf8(shipInternalsD3.select("#transporterMid"));
    $6fdf0ffb4a84c329$export$2447af625794f715(shipInternalsD3.select("#deuteriumTank1"));
    $6fdf0ffb4a84c329$export$2447af625794f715(shipInternalsD3.select("#deuteriumTank2"));
    $6fdf0ffb4a84c329$export$2447af625794f715(shipInternalsD3.select("#antimatterStorage"));
    $6fdf0ffb4a84c329$export$2447af625794f715(shipInternalsD3.select("#tractorBeamMainForward"));
    $6fdf0ffb4a84c329$export$2447af625794f715(shipInternalsD3.select("#tractorBeamMainAft"));
    $6fdf0ffb4a84c329$export$2447af625794f715(shipInternalsD3.select("#tractorBeam2ndHull"));
    $6fdf0ffb4a84c329$export$2447af625794f715(shipInternalsD3.select("#tardis"));
} //? !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!




let $fb2f4fe51f80d60c$var$msdLabelsGroup, $fb2f4fe51f80d60c$var$labels, $fb2f4fe51f80d60c$var$numLabels;
function $fb2f4fe51f80d60c$var$randomizeAllLabelsColor() {
    $fb2f4fe51f80d60c$var$labels.forEach((label)=>{
        const path = label.querySelector("path");
        const dot = label.querySelector('[id^="dot"]');
        const text = label.querySelector("text");
        const randomColor = `var(--${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "secondary",
            "secondaryBright",
            "secondaryBrighter",
            "secondaryBrightest",
...
function $fb2f4fe51f80d60c$export$e26511dac4440c6f() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    $fb2f4fe51f80d60c$var$msdLabelsGroup = CRapp.shipContentDom.querySelector("#msdLabels");
    $fb2f4fe51f80d60c$var$labels = $fb2f4fe51f80d60c$var$msdLabelsGroup.querySelectorAll('[id^="label"]');
    $fb2f4fe51f80d60c$var$numLabels = $fb2f4fe51f80d60c$var$labels.length;
    $fb2f4fe51f80d60c$var$labels.forEach((label)=>{
        const path = label.querySelector("path");
    ...
    $fb2f4fe51f80d60c$var$msdLabelsGroup.dataset.status = "allHidden";
    $fb2f4fe51f80d60c$var$randomizeAllLabelsColor();
}
function $fb2f4fe51f80d60c$export$8baee8e71bc8bf1(faster = null) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    if (faster !== "faster") {
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX3Up", 0, 0, 0, 0.4);
        // use d3 for delayed sound so that it's easily cancelable
        labelsGroupD3.transition().delay(400).duration(350).on("start", ()=>{
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX3Downer", 0, 0, 0, 0.4);
        }).on("end", ()=>{
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("processing", 0, 0, 0, 0.25, 0.8);
        }).transition().delay(250).duration(0).on("start", ()=>{
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("longTaskLow", 0, 0, 0, 0.2, 0.9);
        });
    } else {
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Up", 0, 0, 0, 0.4);
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("processing", 0.15, 0.3, 0, 0.25, (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            0.8,
            0.7,
            0.6
        ]));
    ...
    allLabelsDots.attr("visibility", "visible").transition().delay(()=>{
        return (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(0, 1500) * aniSpeedFactor2;
    }) // random delay start
    .duration(200 * aniSpeedFactor2).attr("opacity", 1).transition().duration(100 * aniSpeedFactor2).attr("opacity", 0).transition().duration(400 * aniSpeedFactor2).attr("opacity", 1).on("end", function(d, i) {
        ...
        d3.select(this.parentNode).select("path").attr("visibility", "visible").transition().duration((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(800, 2000) * aniSpeedFactor1) // random duration
...
function $fb2f4fe51f80d60c$export$9366dc6771d56232(skipAnimation = null) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    // FIRST -- interrupt "show" animation
    d3.selectAll("#msdLabels *").interrupt();
    ...
    if (skipAnimation !== "skipAnimation") {
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX1Downer", 0, 0, 0, 0.6);
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("warningLong", 0, 0, 0, 0.3, 0.92);
    }
    d3.selectAll("#msdLabels text").transition().duration(()=>{
        return toSkipAnimation ? 0 : (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(50, 600);
    }) // random duration
    .attr("opacity", 0).on("end", function() {
        ...
        path.transition().duration(toSkipAnimation ? 0 : (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(600, 1000)).ease(d3.easeCubicInOut).attr("stroke-dashoffset", path.node().dataset.length).on("end", function() {
            this.setAttribute("visibility", "hidden"); // "this" is a dom reference, not d3 obj
            d3.select(this.parentNode).select('[id^="dot"]').transition().duration(toSkipAnimation ? 0 : 400).attr("opacity", 0).on("end", function() {
                this.setAttribute("visibility", "hidden"); // "this" is a dom reference, not d3 obj
                numCompletion++;
                if (numCompletion == $fb2f4fe51f80d60c$var$numLabels) {
...
function $fb2f4fe51f80d60c$export$543099fd07e5174b() {
    const labelsVisibleStatus = document.querySelector("#msdLabels").dataset.visible;
    if (labelsVisibleStatus == "showing") $fb2f4fe51f80d60c$export$9366dc6771d56232();
    else $fb2f4fe51f80d60c$export$8baee8e71bc8bf1();
}
function $fb2f4fe51f80d60c$export$db11f0672e3c0cc0() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
...
function $fb2f4fe51f80d60c$export$c04e772a8363eccc(clientX, clientY) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    CRapp.shipLabelsHotArea.every((hotArea)=>{
        ...
        if (svgPointer.x >= hotArea.rect.x && svgPointer.x <= hotArea.rect.x + hotArea.rect.width && svgPointer.y >= hotArea.rect.y && svgPointer.y <= hotArea.rect.y + hotArea.rect.height) {
            //* found...!!!!!!!!!
            $fb2f4fe51f80d60c$var$shipLabelZoomIn_animationSequence(hotArea);
 ...
 */ function $fb2f4fe51f80d60c$var$shipLabelZoomIn_animationSequence(hotAreaObj) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    if (hitAreaObj !== null) {
        ...
        CRapp.shipRef.shipD3.transition().delay(350).duration(800).on("start", ()=>{
            (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(hotAreaLabel, "blink2");
        }).on("end", ()=>{
            (0, $6fdf0ffb4a84c329$export$b9bb69d98eff82dd)(hitAreaObj);
        });
    }
}
function $fb2f4fe51f80d60c$export$54007cc6d00f8c3a(hitElement) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    $fb2f4fe51f80d60c$var$shipLabelZoomIn_animationSequence(foundLabelObj);
    return true; // found
}
...
function $d7e982942b5ab808$export$1eb886acfb38646b() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    tmpColor = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)(CRapp.allColorCssVarNames);
    ...
    saucer.querySelectorAll('g[id^="plate"] path, path[id^="plate"]').forEach((node)=>{
        node.setAttribute("fill", `var(--${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)(CRapp.allColorCssVarNames)})`);
    });
    if (Math.random() < 0.3) {
        // * randomize ALL STROKES!!! in both saucer & hull !!!
        saucer.querySelectorAll("path, circle").forEach((node)=>{
            node.setAttribute("stroke", `var(--${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)(CRapp.allColorCssVarNames)})`);
        });
        ...
        tmpColor = Math.random() < 0.75 ? tmpColor : (0, $08b51f3f4a82ba06$export$de12a21935b7f164)(CRapp.allColorCssVarNames);
        ritosTop.querySelectorAll("#secondary path, #secondary circle").forEach((node)=>{
            node.setAttribute("stroke", `var(--${tmpColor})`);
        });
    }
...
function $d7e982942b5ab808$export$8e0e260f5562ebea(force) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    const ritosTop = document.querySelector("#msdContainer2 > svg #ritosTop");
    ...
    if (startAnimation) {
        ...
        const newAniClass = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "dottedField",
            "expandingField"
        ]);
        ...
        if (tmpRnd < 0.25) (0, $ba5c5d811afd797b$export$915e86dc1242cd73)(`initiating SIF Level ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "1",
            "2",
            "3",
            "4",
        ...
        else if (tmpRnd < 0.5) (0, $ba5c5d811afd797b$export$915e86dc1242cd73)(`extended hull plating magnetic shielding activated`);
        else if (tmpRnd < 0.75) (0, $ba5c5d811afd797b$export$915e86dc1242cd73)(`SIF monitoring on secondary hull plating`);
        else (0, $ba5c5d811afd797b$export$915e86dc1242cd73)(`structural integrity field at ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(70, 99)}%`);
        ...
        CRapp.ritosTopFieldTimer = setTimeout(()=>{
            $d7e982942b5ab808$export$44c657e682c0f9a8();
        }, 13000);
        // * randomize field stroke styles
        field.setAttribute("stroke", `var(--${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)(CRapp.nonDarkColorCssVarNames)})`);
        field.setAttribute("stroke-width", (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(10, 35)); // max ideal width 35, min at 10
        // 20 15       50 30 
        field.setAttribute("stroke-dasharray", `${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(20, 50)} ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(15, 30)}`);
        field.style.animationDuration = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(3000, 7000) + "ms";
        ...
        if (newAniClass == "dottedField") {
            field.style.animationDirection = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                "normal",
                "reverse",
                "alternate",
                "alternate-reverse"
            ]);
            field.setAttribute("transform", `translate(${cx} ${cy}) scale(${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(95, 115) * 0.01}) translate(-${cx} -${cy})`);
        } else // for 'expandingField'
        field.removeAttribute("transform");
        // applies to either class animation:
        field.style.animationTimingFunction = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "ease-in-out",
            "ease-in",
            "ease-out",
            "linear",
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX1Downer", 0, 0, 0, 0.3);
        $d7e982942b5ab808$export$44c657e682c0f9a8();
    }
}
function $d7e982942b5ab808$export$44c657e682c0f9a8() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    clearTimeout(CRapp.ritosTopFieldTimer);
...
function $d7e982942b5ab808$var$setBracketsWindowStyle() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    bracketsWindow.querySelectorAll("*").forEach((element)=>{
        if (element.hasAttribute("fill")) element.setAttribute("fill", `var(--${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)(CRapp.allColorCssVarNames)})`);
        if (element.hasAttribute("stroke")) element.setAttribute("stroke", `var(--${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)(CRapp.allColorCssVarNames)})`);
        if (element.getAttribute("id").includes("bar")) {
            element.setAttribute("stroke-dasharray", `72 6 ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                0,
                6
            ]) * 6} ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 12) * 6} ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                0,
                6
            ]) * 6} ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(6, 12) * 6}  ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                0,
                6
            ]) * 6} ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 12) * 6} ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                0,
                ...
                0,
                6
            ]) * 6} ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 12) * 6}`);
            // element.setAttribute('stroke-opacity', `${randomIntRange(50,100)*0.01}`);
            element.style.animationDuration = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                23,
                37,
                47,
                173,
            ...
            element.style.animationTimingFunction = `steps(${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(10, 30),
                (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(350, 500)
            ])})`;
        }
    });
}
function $d7e982942b5ab808$export$a3c8ae47def8917d(force) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    if (startAnimation) {
        ...
        $d7e982942b5ab808$var$setBracketsWindowStyle();
        bracketsWindow.classList.add("activeAnimation");
        // * output info to log
        const tmpRnd = Math.random();
        if (tmpRnd < 0.3) (0, $ba5c5d811afd797b$export$915e86dc1242cd73)(`Shield ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "Modulation",
            "harmonic"
        ])} set at ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(200, 400)}.${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(0, 9)} MHz frequency`);
        else if (tmpRnd < 0.6) (0, $ba5c5d811afd797b$export$915e86dc1242cd73)(`Shield activated monitoring • space debris impact`);
        else (0, $ba5c5d811afd797b$export$915e86dc1242cd73)(`Shield strength at ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(60, 99)}% ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "",
            "",
            "",
            "",
        ...
        CRapp.ritosFrontShieldTimer = setTimeout(()=>{
            $d7e982942b5ab808$export$f88a5c091fd7827b();
        }, 13000);
        // * randomize arc shield colors, dash                         & speed & direction
        const newColor = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)(CRapp.allColorCssVarNames);
        const newDashArray = Math.random() < 0.5 ? "none" : `${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(20, 50)} ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(5, 30)}`;
        const newDuration = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 6);
        ...
        shieldBg.style.animationDuration = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1000, 6000) + "ms";
    } else {
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX3Downer", 0, 0, 0, 0.3);
        //* also starts the bracketsWindow css animation
        bracketsWindow.classList.remove("activeAnimation");
        $d7e982942b5ab808$export$f88a5c091fd7827b();
    }
}
function $d7e982942b5ab808$export$f88a5c091fd7827b() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    clearTimeout(CRapp.ritosFrontShieldTimer);
...
function $8fa320b0760973ea$export$c0676d6c9e7dce11() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    document.querySelector("#msdContainer svg #rubberDucky_hotzone").onpointerdown = ()=>{
        ...
        const currentTranslate = rDucky.dataset.translate ?? "0 0";
        const currentHFlip = Number(rDucky.dataset.hFlip ?? 1);
        ...
        // start animation ===================
        d3.select(rDucky).transition().duration(400).ease(d3.easeQuadIn).attr("transform", `translate(${currentTranslate}) scale(${currentHFlip * 8} 8) rotate(${(0, $08b51f3f4a82ba06$export$a13251365167ea49)() * (0, $08b51f3f4a82ba06$export$3c5f89dae98e900b)(0, 40)})`).on("end", function() {
            this.setAttribute("opacity", 0.2);
            setTimeout(()=>{
                this.setAttribute("opacity", .7);
            }, 150);
        }).transition().delay(300).on("start", function() {
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("exitTask", 0, 0, 0, 0.8, 1.15);
        }).duration(300).ease(d3.easeQuadIn).attr("transform", `translate(${currentTranslate}) scale(${currentHFlip * .1} .1) rotate(${(0, $08b51f3f4a82ba06$export$a13251365167ea49)() * (0, $08b51f3f4a82ba06$export$3c5f89dae98e900b)(100, 350)})`).attr("opacity", 0).on("end", function() {
            // console.log(this);
            $8fa320b0760973ea$var$moveRubberDucky();
        });
    };
}
/**
 * * when calling this function, make sure   'rDucky.dataset.aniInProgress'  has been set to TRUE
 */ function $8fa320b0760973ea$var$moveRubberDucky() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    const rDuckyPositions = CRapp.rubberDuckyPositions;
    const rDucky = document.querySelector("#msdContainer svg #rubberDucky");
    const currentRdIndex = Number(rDucky.dataset.rdIndex ?? 0);
    // get new random position
    let newIndex = (0, $08b51f3f4a82ba06$export$3c5f89dae98e900b)(rDuckyPositions.length);
    if (newIndex == currentRdIndex) // if duplicate, shift the newIndex to right by amount of (1 to 0.7*arrayLength), the mod it
    newIndex = (newIndex + (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, Math.round(rDuckyPositions.length * .7))) % rDuckyPositions.length;
    rDucky.dataset.rdIndex = newIndex;
    ...
    const newHFlip = (0, $08b51f3f4a82ba06$export$a13251365167ea49)();
    ...
    d3.select(rDucky).transition().delay((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(0, 1000)).duration((0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
        800,
        1200
...
function $8fa320b0760973ea$export$53b47a456413a20() {
    const rDucky = document.querySelector("#msdContainer svg #rubberDucky");
    ...
    d3.select(rDuckyTarget).attr("transform", `translate(${currentTranslate}) scale(3) rotate(0)`).attr("opacity", 1).attr("visibility", "visible").transition("blinking").delay(200).duration(0).attr("opacity", 0).transition("blinking").delay(200).on("start", ()=>{
        ...
        (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("Rubber Ducky located", "timePrefix");
    ...
    .attr("transform", `translate(${currentTranslate}) scale(${currentHFlip * 7} 7) rotate(0)`).on("start", ()=>{
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Upper", 0.4, 0, 0, 0.7);
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("notification", 0, 0, 0, 0.7);
    }).on("end", ()=>{
        $8fa320b0760973ea$var$moveRubberDucky();
    });
}
...
const $13e995fcd4f68ee5$var$localStoragePrefix = "ProjectRITOS";
// * All Possible Settings & Options (first value = default)
const $13e995fcd4f68ee5$var$allAvailableUserSettings = {
...
// * DEFAULT settings
const $13e995fcd4f68ee5$var$allDefaultUserSettings = {
    useLastVisitSettings: $13e995fcd4f68ee5$var$allAvailableUserSettings.useLastVisitSettings[0],
    shipName: `U.S.S. Cerritos`,
    shipClass: `California`,
    shipRegistry: `NCC-75567`,
    colorSchemeName: "Ritos Yellow",
    bgHue: $13e995fcd4f68ee5$var$allAvailableUserSettings.bgHue[0],
    bgLevel: $13e995fcd4f68ee5$var$allAvailableUserSettings.bgLevel[0],
    softVignette: $13e995fcd4f68ee5$var$allAvailableUserSettings.softVignette[0],
    ldGlare: $13e995fcd4f68ee5$var$allAvailableUserSettings.ldGlare[0],
    audioEnabled: $13e995fcd4f68ee5$var$allAvailableUserSettings.audioEnabled[0],
    audioFxLevel: 0.47,
    audioBgLevel: 0.3,
    clockType: $13e995fcd4f68ee5$var$allAvailableUserSettings.clockType[0]
};
function $13e995fcd4f68ee5$export$62f74afbfe07916b(key, value) {
    if ($13e995fcd4f68ee5$var$allAvailableUserSettings[key][0] == "text" && typeof value === "string") {
        if (value.length >= $13e995fcd4f68ee5$var$allAvailableUserSettings[key][1] && value.length <= $13e995fcd4f68ee5$var$allAvailableUserSettings[key][2]) return true;
        else return `error: ${key} text can only have ${$13e995fcd4f68ee5$var$allAvailableUserSettings[key][1]} to ${$13e995fcd4f68ee5$var$allAvailableUserSettings[key][2]} characters`;
    } else return `error: ${key} does not have a valid value`;
}
function $13e995fcd4f68ee5$export$36c7bb024fc249a2() {
    // * Read Locally Saved Settings Values
    const userLocalStorageSettings = $13e995fcd4f68ee5$var$readLocalSettings();
    // * set current user Session settings to default
    let userSessionSettings = {
        ...$13e995fcd4f68ee5$var$allDefaultUserSettings
    };
    ...
    Object.keys($13e995fcd4f68ee5$var$allAvailableUserSettings).forEach((key)=>{
        const availableValues = $13e995fcd4f68ee5$var$allAvailableUserSettings[key];
    ...
    if (userSessionSettings.audioEnabled && userSessionSettings.audioFxLevel <= 0) {
        ...
        userSessionSettings.audioFxLevel = $13e995fcd4f68ee5$var$allDefaultUserSettings.audioFxLevel;
    }
    return userSessionSettings;
}
function $13e995fcd4f68ee5$export$65454018d8d76fd3(exceptionKeys = null) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    Object.keys(CRapp.userSessionSettings).forEach((key)=>{
        switch(key){
            ...
            case "shipClass":
            case "shipRegistry":
                (0, $ba5c5d811afd797b$export$f7d3c41002dae854)(key, CRapp.userSessionSettings[key]);
                break;
            case "colorSchemeName":
                (0, $ba5c5d811afd797b$export$878a77c0bab57c97)(CRapp.userSessionSettings[key]);
                break;
            case "bgHue":
                (0, $ba5c5d811afd797b$export$5cff1c8d974e3f0b)(Number(CRapp.userSessionSettings[key]));
                break;
            case "bgLevel":
                (0, $ba5c5d811afd797b$export$1bda2b6d3dd4d993)(Number(CRapp.userSessionSettings[key]));
                break;
            case "softVignette":
                (0, $ba5c5d811afd797b$export$6b9b218407705316)(CRapp.userSessionSettings[key], "noLog", "mute");
                break;
            case "ldGlare":
                if (!exceptionKeys.includes("ldGlare")) (0, $ba5c5d811afd797b$export$4a4f808287652e93)(CRapp.userSessionSettings[key], "noLog", "mute");
                break;
            default:
                break;
        }
 ...
 */ function $13e995fcd4f68ee5$var$applySingleUserSettingToApp(category, value) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
// app
}
/**
 ...
 * @param {*} key 
 * @param {*} value -- value has been sanitized
 */ function $13e995fcd4f68ee5$var$processUserSettingChange(key, value) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    switch(key){
        case "shipName":
            if (value.trim() === "") (0, $ba5c5d811afd797b$export$f7d3c41002dae854)(key, "U.S.S. CERRITOS");
            else (0, $ba5c5d811afd797b$export$f7d3c41002dae854)(key, value);
            break;
        case "shipClass":
            if (value.trim() === "") (0, $ba5c5d811afd797b$export$f7d3c41002dae854)(key, "CALIFORNIA");
            else (0, $ba5c5d811afd797b$export$f7d3c41002dae854)(key, value);
            break;
        case "shipRegistry":
            if (value.trim() === "") (0, $ba5c5d811afd797b$export$f7d3c41002dae854)(key, "NCC-75567");
            else (0, $ba5c5d811afd797b$export$f7d3c41002dae854)(key, value);
            break;
        case "audioEnabled":
            if (value && (0, $dab718e507db4475$export$521ad490824e86fd)() == 0) {
                const newLevel = $13e995fcd4f68ee5$var$allDefaultUserSettings.audioFxLevel * 0.33;
                (0, $dab718e507db4475$export$6d762aca21a0d7bf)(newLevel);
            }
            (0, $dab718e507db4475$export$c8cdacb776d3b001)(value);
            break;
        case "audioFxLevel":
            (0, $dab718e507db4475$export$6d762aca21a0d7bf)(value);
            break;
    ...
    if (CRapp.userSessionSettings.useLastVisitSettings === true) {
        ...
        Object.keys($13e995fcd4f68ee5$var$allDefaultUserSettings).forEach((key)=>{
            $13e995fcd4f68ee5$var$saveLocalSetting(key, CRapp.userSessionSettings[key]);
        });
        else // ! save this changed setting to local
        $13e995fcd4f68ee5$var$saveLocalSetting(key, value);
    } else if (key == "usePreviousSettings") // ! clean out localStorage
    $13e995fcd4f68ee5$var$deleteLocalSettings();
}
function $13e995fcd4f68ee5$export$731cb1e997115006(key, value) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    if (key in CRapp.userSessionSettings == false) return;
    CRapp.userSessionSettings[key] = value;
    if (CRapp.userSessionSettings.useLastVisitSettings === true) $13e995fcd4f68ee5$var$saveLocalSetting(key, value);
}
/**
 ...
 */ function $13e995fcd4f68ee5$var$readLocalSettings() {
    let userLocalStorageSettings;
    let foundPreviousLocalStorageSettings = false;
    try {
        userLocalStorageSettings = JSON.parse(localStorage.getItem($13e995fcd4f68ee5$var$localStoragePrefix));
 ...
 */ function $13e995fcd4f68ee5$var$saveLocalSetting(key, value) {
    let userLocalStorageSettings = $13e995fcd4f68ee5$var$readLocalSettings();
    userLocalStorageSettings[key] = value;
    try {
        localStorage.setItem($13e995fcd4f68ee5$var$localStoragePrefix, JSON.stringify(userLocalStorageSettings));
    } catch (error) {
 ...
 */ function $13e995fcd4f68ee5$var$deleteLocalSettings() {
    try {
        localStorage.removeItem($13e995fcd4f68ee5$var$localStoragePrefix);
    } catch (error) {
        console.log("localStorage error");
        console.log(error);
    }
}
function $13e995fcd4f68ee5$var$setShipPreSet(shipNameRef) {
    ...
    $13e995fcd4f68ee5$var$processUserSettingChange("shipName", shipName);
    $13e995fcd4f68ee5$var$processUserSettingChange("shipClass", shipClass);
    $13e995fcd4f68ee5$var$processUserSettingChange("shipRegistry", shipRegistry);
    (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX1Up", 0, 0, 0, 0.25);
}
/**
 ...
 * @param {*} e 
 * @returns 
 */ function $13e995fcd4f68ee5$var$checkPointDownEvent(e) {
    if ("preset" in e.target.dataset) {
        $13e995fcd4f68ee5$var$setShipPreSet(e.target.dataset.preset);
        return;
    }
    ...
    switch(e.target.dataset.key){
        ...
        case "audioEnabled":
            ...
            if (e.target.dataset.key == "usePreviousSettings") {
                if (value) (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Up");
                else (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX1Down");
                $13e995fcd4f68ee5$var$processUserSettingChange("usePreviousSettings", value);
            } else {
                if (value) {
                    if ((0, $dab718e507db4475$export$521ad490824e86fd)() == 0) {
                        const newLevel = $13e995fcd4f68ee5$var$allDefaultUserSettings.audioFxLevel * 0.33;
                        (0, $dab718e507db4475$export$6d762aca21a0d7bf)(newLevel);
                        $13e995fcd4f68ee5$var$setVolumeLevelUi(document.getElementById("audioFxLevel"), Math.round(newLevel * 100));
                    }
                    (0, $dab718e507db4475$export$80cb197f7ea4fe13)("shortRandomBeep", 0, 0, 0, 0.6);
                } else (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(e.target, "blink2");
                $13e995fcd4f68ee5$var$processUserSettingChange("audioEnabled", value);
            }
            break;
        case "audioFxLevel":
            ...
            $13e995fcd4f68ee5$var$setVolumeLevelUi(e.target, level);
            if (level > 0) {
                (0, $dab718e507db4475$export$c8cdacb776d3b001)(true); //* force audio on
                ...
                (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX1Up", 0, 0, 0, 0.8);
            } else {
                (0, $dab718e507db4475$export$c8cdacb776d3b001)(false); //* force audio off
                // update audioMainSwitch UI....
            ...
            $13e995fcd4f68ee5$var$processUserSettingChange("audioFxLevel", level * 0.01);
            break;
        default:
            break;
    }
}
function $13e995fcd4f68ee5$var$checkInputValueChangeEvent(e) {
    if (!("key" in e.target.dataset)) return;
    if (e.target.value.trim() == "") e.target.value = ""; // preventing blank empty string
    if (e.target.dataset.key == "shipName" || e.target.dataset.key == "shipClass" || e.target.dataset.key == "shipRegistry") $13e995fcd4f68ee5$var$processUserSettingChange(e.target.dataset.key, e.target.value);
}
function $13e995fcd4f68ee5$var$setVolumeLevelUi(node, newLevel) {
    node.style.setProperty("--audioLevel", newLevel + "%");
    node.dataset.audioLevel = `${newLevel}%`; // for ::after's content -- has to be string
}
function $13e995fcd4f68ee5$var$addLocalSettingsEventListener() {
    const localSettings = document.getElementById("localSettings");
    localSettings.addEventListener("pointerdown", $13e995fcd4f68ee5$var$checkPointDownEvent, false);
    localSettings.addEventListener("input", $13e995fcd4f68ee5$var$checkInputValueChangeEvent, false);
}
function $13e995fcd4f68ee5$var$removeLocalSettingsEventListener() {
    const localSettings = document.getElementById("localSettings");
    localSettings.removeEventListener("pointerdown", $13e995fcd4f68ee5$var$checkPointDownEvent, false);
    localSettings.removeEventListener("input", $13e995fcd4f68ee5$var$checkInputValueChangeEvent, false);
}
function $13e995fcd4f68ee5$export$5262bb5d2849f15() {
    const localSettings = document.getElementById("localSettings");
    clearTimeout(Number(localSettings.dataset.timerId));
    if (localSettings.classList.contains("show")) {
        // * hide ====
        $13e995fcd4f68ee5$var$removeLocalSettingsEventListener();
        ...
        // * show ====
        $13e995fcd4f68ee5$var$addLocalSettingsEventListener();
...
function $13e995fcd4f68ee5$export$131c68bd6f589ff1() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    const localSettingsContent = document.getElementById("localSettingsContent");
    let tmpValue;
    ...
    localSettingsContent.querySelector(`input[data-key="shipName"]`).value = CRapp.userSessionSettings.shipName.toUpperCase() == $13e995fcd4f68ee5$var$allDefaultUserSettings.shipName.toUpperCase() ? "" : CRapp.userSessionSettings.shipName;
    localSettingsContent.querySelector(`input[data-key="shipClass"]`).value = CRapp.userSessionSettings.shipClass.toUpperCase() == $13e995fcd4f68ee5$var$allDefaultUserSettings.shipClass.toUpperCase() ? "" : CRapp.userSessionSettings.shipClass;
    localSettingsContent.querySelector(`input[data-key="shipRegistry"]`).value = CRapp.userSessionSettings.shipRegistry.toUpperCase() == $13e995fcd4f68ee5$var$allDefaultUserSettings.shipRegistry.toUpperCase() ? "" : CRapp.userSessionSettings.shipRegistry;
}


function $5d1043473d96ae14$export$66453c7132c7178e(textTime, textDate = null, ringClockParam = "noRingClock") {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    if (CRapp.userSessionSettings.clockType == "none") {
        ...
        // textSS.textContent = ' ';
        textTime.textContent = (0, $08b51f3f4a82ba06$export$cc4d98609e3a31e7)(6);
        return;
    }
    // SHOW clock ==============================================
    ...
    CRapp.clockIntervalTimer = setInterval(()=>{
        ...
        if (Math.random() < .3) {
            ringRandom.style.strokeDashoffset = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(-1438, 1438);
            ringRandom.style.transitionDuration = (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(.4, 3) + "s";
            ringRandom.style.transitionTimingFunction = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                "ease",
        ...
        if (SS == 58) {
            if (!CRapp.bufferTimeStatus) (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX1Down", 0, 0, 0, 0.2);
            ...
            .attr("r", (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                154,
                (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(55, 175)
            ...
            if (Math.random() < .2) {
                ...
                ringCenter.setAttribute("r", (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                    154,
                    (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(55, 175)
                ]));
                ringCenter.style.transitionDuration = null;
                ringCenter.style.transitionDuration = (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(0.3, 1.7) + "s";
                ringCenter.style.transitionTimingFunction = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                    "ease",
                    "cubic-bezier(.8, 0, .2, 1)",
                    "ease-in",
                    "ease-out"
            ...
            if (!CRapp.bufferTimeStatus) (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX1Down", 0, 0, 0, 0.3);
        } else if (SS == 0 && !CRapp.bufferTimeStatus) {
            if (MM == 0) {
                (0, $dab718e507db4475$export$80cb197f7ea4fe13)("lowProfileTask", 0, 0, 0, 0.3);
                (0, $dab718e507db4475$export$80cb197f7ea4fe13)("exitTask", 1.1, 0, 0, 0.5);
            } else (0, $dab718e507db4475$export$80cb197f7ea4fe13)((0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                "affirmative",
                "negative"
            ]), 0, 0, 0, 0.3);
        }
...
function $5d1043473d96ae14$export$1ea5135a72d2338a() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    clearInterval(CRapp.clockIntervalTimer);
    CRapp.clockIntervalTimer = null;
}
function $5d1043473d96ae14$export$9504c7d42aa1dd15() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
...
function $5d1043473d96ae14$export$189cabd35bb0035c(clockNode) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(clockNode, "blink1");
    ...
    $5d1043473d96ae14$var$updateClockTypeUi(newClockType);
    (0, $13e995fcd4f68ee5$export$731cb1e997115006)("clockType", newClockType);
    (0, $ba5c5d811afd797b$export$915e86dc1242cd73)(`Changing to ${newClockType} clock type`);
    (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Downer", 0, 0, 0, 0.25);
}
function $5d1043473d96ae14$var$updateClockTypeUi(newClockType) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
 ...
 */ function $07e5e03ce19a9429$var$startTargetScan() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    (0, $ba5c5d811afd797b$export$c9e8cccd464b5a6c)(target);
    (0, $ba5c5d811afd797b$export$c9e8cccd464b5a6c)(targetStar);
    (0, $ba5c5d811afd797b$export$c9e8cccd464b5a6c)(targetOuter);
    (0, $ba5c5d811afd797b$export$c9e8cccd464b5a6c)(targetInnerH);
    (0, $ba5c5d811afd797b$export$c9e8cccd464b5a6c)(targetInnerV);
    ...
    const setStarColor = ()=>{
        ...
        `drop-shadow(0 0 8px #fff) drop-shadow(0 0 32px #fff) brightness(0.6) sepia(1) saturate(${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 8)}) hue-rotate(${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(0, 360)}deg)`;
    };
    targetStar.style.opacity = 0;
    targetOuter.setAttribute("opacity", 0);
    targetInnerV.setAttribute("opacity", 0);
    targetInnerH.setAttribute("fill", `var(--${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)(CRapp.nonDarkColorCssVarNames)})`);
    ...
    let remainingCycles = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(4, 10);
    // remainingCycles = 2; // ! DEV <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< 
    let coordinateX, coordinateY;
    //* CYCLE setup #########################################################################
    const scanningCycle = ()=>{
        // console.log('One SCANNING CYCLE is staring =======================================');
        coordinateX = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(areaBoxXRange[0], areaBoxXRange[1]);
        coordinateY = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(areaBoxYRange[0], areaBoxYRange[1]);
        const coordinate = `${coordinateX} ${coordinateY}`;
        const deg = (0, $08b51f3f4a82ba06$export$a13251365167ea49)() * (0, $08b51f3f4a82ba06$export$3c5f89dae98e900b)(4) * 180;
        const finalScale = (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(0.2, 1.4);
        ...
        setLinesAndBlink();
        const initDelay = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(0, 2400);
        const initDuration = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(800, 4000);
        ...
        .transition().delay(initDelay).duration(initDuration).ease((0, $ba5c5d811afd797b$export$f681ad6169264fc7)())//* moving target into new coordinate
        .attr("transform", `translate(${coordinate}) rotate(0) scale(${(0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(0.6, 1.4)})`).style("opacity", 0.4).on("end", ()=>{
            // * target now in new location, lines start showing
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("deployed", 0, 0, 0, 0.25); // ? SOUND <<<<<<<<<<<<<<<<<<<<
            // blink target
            target.style.opacity = 1;
            (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(target);
            // blink lines
            targetLines.setAttribute("opacity", 1);
            (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(targetLines); // blink the group of lines
            ...
            const newColor = `var(--${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)(CRapp.nonDarkColorCssVarNames)})`; // ! either primary or secondary color here
            ...
            d3.select(targetStar).attr("transform", `translate(${coordinate}) rotate(${starRotation}) scale(${(0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(0.6, 1.4)})`).transition().delay(400).duration(700).on("start", ()=>{
                (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(targetStar);
            }).transition().duration(1000).ease((0, $ba5c5d811afd797b$export$f681ad6169264fc7)()).style("opacity", (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(0.6, 1.2)).transition().delay((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(900, 3000)).duration((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(800, 3000)).ease((0, $ba5c5d811afd797b$export$f681ad6169264fc7)()).style("opacity", 0);
        ...
        .delay(1000 * targetLockingFactor).duration(9000 * targetLockingFactor).on("start", ()=>{
            ...
            (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(targetOuter);
            ...
            d3.selectAll([
                ...
                if (i == 0) (0, $dab718e507db4475$export$80cb197f7ea4fe13)((0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                    "warningHigh",
                    "warningLow"
                ]), 0.75, 0, 0, 0.3); // ? SOUND <<<<<<<<<<<<<<<<<<<<
            })// ! set to smaller scale & rotate
            .transition().delay(400).duration(1500).ease(d3.easeBackInOut.overshoot(4)).attr("transform", `scale(0.5) rotate(${(0, $08b51f3f4a82ba06$export$a13251365167ea49)() * (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 10) * 90})`).on("end", function() {
            ...
            .transition().delay(1200).duration(1500).ease(d3.easeBackInOut.overshoot(6)).attr("transform", `scale(1.3) rotate(${(0, $08b51f3f4a82ba06$export$a13251365167ea49)() * (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 10) * 90})`).on("start", ()=>{
                // * both inner & outer targets start rotating
                (0, $dab718e507db4475$export$80cb197f7ea4fe13)("processing", 0, 0.2, 0, 0.15, 0.9); // ? SOUND <<<<<<<<<<<<<<<<<<<<
            }).on("end", function() {
                this.setAttribute("transform", "scale(1.3)"); // reset rotate back to zero, but keeping the scale
                (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Upper", 0, 0, 0, 0.5); // ? SOUND <<<<<<<<<<<<<<<<<<<<
            ...
            .transition().delay(400).duration(1500).ease(d3.easeBackInOut.overshoot(6)).on("start", ()=>{
                ...
                d3.select(imageNode).transition().delay(950).duration((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(4, 15) * 100).ease(d3.easeBackOut).attr("transform", `scale(1.${(0, $08b51f3f4a82ba06$export$dd918e842b943f50)((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(5, 17), 2)})`);
                ...
                (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(targetInnerV);
                (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(targetInnerH);
                (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(targetOuter);
                ...
                targetOuter.setAttribute("fill", `var(--${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)(CRapp.nonDarkColorCssVarNames)})`);
                // ! OVERALL TARGET: rotate in 90x deg w/ offset by 45, with another random scale
                d3.select(target).transition("rotate1").duration((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(6, 12) * 100).ease((0, $ba5c5d811afd797b$export$f681ad6169264fc7)()).attr("transform", `translate(${coordinate}) rotate(${(0, $08b51f3f4a82ba06$export$a13251365167ea49)() * ((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(0, 2) * 90 + 45)}) scale(${(0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(0.6, 1.4)})`).on("start", ()=>{
                    (0, $dab718e507db4475$export$80cb197f7ea4fe13)("processing", 0, 0.4, 0, 0.13); // ? SOUND <<<<<<<<<<<<<<<<<<<< 
                }).on("end", ()=>{
                    (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Downer", 0, 0, 0, 0.25); // ? SOUND <<<<<<<<<<<<<<<<<<<< 
                });
            });
        })// .on('end', ()=>{
        //     if (!showTargetLocking) return; // ! <===== skipping if not showing target locking
        ...
        .transition().delay((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(50, 600)).duration((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(6, 20) * 100).ease((0, $ba5c5d811afd797b$export$f681ad6169264fc7)()).on("start", ()=>{
            // * change IMAGE filter
            const rnd = Math.random();
            let imgFilter = "";
            if (rnd < 0.15) imgFilter = `invert(${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(7, 10) * 0.1})`;
            if (rnd < 0.3) imgFilter = `saturate(${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(0, 7) * 0.1})`;
            else if (rnd < .45) imgFilter = `saturate(${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(11, 20) * 0.1}) brightness(${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(11, 20) * 0.1})`;
            else if (rnd < .6) imgFilter = "blur(8px)";
            else if (rnd < .75) imgFilter = `hur-rotate(${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(40, 330)})`;
            imageNode.style.filter = imgFilter;
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("shortBeep", 0, 0, 0, 0.3); // ? SOUND <<<<<<<<<<<<<<<<<<<<
        }).attr("transform", `translate(${coordinate}) rotate(${deg}) scale(${(0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(0.2, 1.4)})`).on("end", ()=>{
            if (!showTargetLocking) return; // ! <===== skipping if not showing target locking
            // * >>>>> STAR blinking after TARGET rotates & scales
            (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(targetStar);
        }).transition().duration((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2, 16) * 100).ease((0, $ba5c5d811afd797b$export$f681ad6169264fc7)()).attr("transform", `translate(${coordinate}) rotate(${Math.random() < 0.5 ? deg : 0}) scale(${finalScale})`).on("start", ()=>{
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("exitTask", 0, 0, 0, 0.2, 0.85); // ? SOUND <<<<<<<<<<<<<<<<<<<<
        }).on("end", ()=>{
            if (!showTargetLocking) return; // ! <===== skipping if not showing target locking
            ...
            // * reset image scale <<<<<<<<<<<<<<
            d3.select(imageNode).transition().delay(2000).duration((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(12, 25) * 100).ease(d3.easeCubicInOut).attr("transform", "scale(1)").on("start", ()=>{
                (0, $dab718e507db4475$export$80cb197f7ea4fe13)("negative", 0.3, 0, 0, 0.15, 0.9); // ? SOUND <<<<<<<<<<<<<<<<<<<<
            }).on("end", ()=>{
                (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX1Down", 0, 0, 0, 0.3); // ? SOUND <<<<<<<<<<<<<<<<<<<<
            });
        }).transition().delay((0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2500, 7000)).duration(3700) // duration should be longer than the animation dur within
        .on("start", ()=>{
            if (!showTargetLocking) return; // ! <===== skipping if not showing target locking
            ...
            d3.selectAll([
                ...
                return 100 * (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(0, 8); // max 800ms
            }).duration(()=>{
                return 100 * (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(4, 10); // max 1000ms
            }).attr("opacity", 0).on("start", ()=>{
                (0, $dab718e507db4475$export$80cb197f7ea4fe13)("shortBeep", 0, 0, 0, 0.2); // ? SOUND <<<<<<<<<<<<<<<<<<<<
            });
        ...
        // total duration within is 1800ms ???
            ...
            // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX3Downer", 0, 0, 0, 0.3); // ? SOUND <<<<<<<<<<<<<<<<<<<<
            ...
            if (remainingCycles == 0) {
                ...
                target.style.opacity = 0;
                $07e5e03ce19a9429$var$jwstImageExitAnimation("restart");
            } else {
                (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(target, "blink1");
                scanningCycle();
            }
        // ! DEV ... tmp reset
        // targetOuter.setAttribute('opacity',0);
    ...
    function setLinesAndBlink() {
        // random color
        const newColor = `var(--${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)(CRapp.nonDarkColorCssVarNames)})`;
        targetLineV.setAttribute("stroke", newColor);
        targetLineH.setAttribute("stroke", newColor);
        // random stroke-dasharray
        const newDasharray = `${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(6, 40)} ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            0,
            (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(6, 40)
        ])}`;
        targetLineV.setAttribute("stroke-dasharray", newDasharray);
        targetLineH.setAttribute("stroke-dasharray", newDasharray);
        // random stroke-width
        const newWidth = Math.random() < 0.5 ? (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(4, 10) : (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(30, 100); // think or thick
        targetLineV.setAttribute("stroke-width", newWidth);
        targetLineH.setAttribute("stroke-width", newWidth);
        // prep lines opacity
        const newInitOpacity = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(3, 8) * 0.1;
        ...
        const durH = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(100, 1200);
        const durV = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(100, 1200);
        ...
        d3.select(targetLineH).transition().duration(durH).ease((0, $ba5c5d811afd797b$export$f681ad6169264fc7)()).attr("y1", areaBox.y + coordinateY) // move to coordinate
        .attr("y2", areaBox.y + coordinateY);
        d3.select(targetLineV).transition().duration(durV).ease((0, $ba5c5d811afd797b$export$f681ad6169264fc7)()).on("start", ()=>{
        ...
        .attr("x2", areaBox.x + coordinateX).transition().delay(150 + durDelay).duration(1500).on("start", ()=>{
            ...
            const brighterOpacity = (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(newInitOpacity, 1);
            targetLineV.setAttribute("opacity", brighterOpacity);
            targetLineH.setAttribute("opacity", brighterOpacity);
        });
    }
}
function $07e5e03ce19a9429$var$stopTargetScan() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
...
function $07e5e03ce19a9429$var$loadNewJwstImage() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    if ((0, $10cf9956fee6f4c6$export$9ae4d28a04c72663)(newImageIndex)) {
        // plan for next iteration
        CRapp.jwstNextImgIndex = (0, $08b51f3f4a82ba06$export$3c5f89dae98e900b)(CRapp.jwstImg.fileRef.length);
        if (CRapp.jwstNextImgIndex == newImageIndex) CRapp.jwstNextImgIndex = (CRapp.jwstNextImgIndex + 1) % CRapp.jwstImg.fileRef.length;
        (0, $10cf9956fee6f4c6$export$4ab67db1ad2f21ae)(CRapp.jwstNextImgIndex); // preload next iteration's image
    } else {
        ...
        let tmpIndex = (0, $08b51f3f4a82ba06$export$3c5f89dae98e900b)(CRapp.preloadedIndexes.length);
    ...
    (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("loading image from NASA’s James Webb Space Telescope...");
}
/**
 * image is present already, now fade it out
 */ function $07e5e03ce19a9429$var$jwstImageExitAnimation(restart = null) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    const jwstGroup = document.querySelector("#msdContainer > svg #jwstImageGroup");
    ...
    d3.select(roundCornerMask).interrupt().transition().duration(400).style("opacity", 0).on("end cancel interrupt", ()=>{
        if (restart === "restart") $07e5e03ce19a9429$var$jwstImageEnterAnimation();
        else {
...
function $07e5e03ce19a9429$var$jwstImageEnterAnimation() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    $07e5e03ce19a9429$var$loadNewJwstImage();
    // prep init
    const jwstGroup = document.querySelector("#msdContainer > svg #jwstImageGroup");
    const maskNode = jwstGroup.querySelector("mask");
    const roundCornerMask = maskNode.querySelector("#jwstMaskRef");
    ...
    if (Math.random() < 0.5) {
        ...
        const rectHeight = Math.random() < .5 ? ()=>{
            return (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(90, 250);
        } : ()=>{
            return (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(10, 70);
        };
    ...
    .on("start", ()=>{
        ...
        maskNode.querySelectorAll("rect").forEach((element)=>{
            element.style.transition = `opacity ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(100, 1000)}ms ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                "linear",
                "ease",
                "ease-in",
                "ease-out"
            ])} ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(0, 600)}ms`;
            if (removeAllMaskRectsAfterEnterAnimation) element.style.opacity = 1;
            else element.style.opacity = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2, 5) * 0.2; // opacity: 0.4 to 1 q 0.2
        });
        ...
        CRapp.jwstSoundTimer = setTimeout(()=>{
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("processing", 0, 0, 0, (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                0.15,
                0.3,
                0.5
            ]), (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            ...
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("processing", 0.37, 0, 0, (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                0.11,
                0.17,
                0.29
            ]), (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
        ...
        (0, $ba5c5d811afd797b$export$915e86dc1242cd73)(CRapp.jwstImg.description[CRapp.jwstCurrentImgIndex], null, true);
        // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        //* huggy KOALA reference 
    ...
    // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        $07e5e03ce19a9429$var$startTargetScan(); //* <<<<<<<<<<<<<<<<< <<<<<<<<<<<<<<<< <<<<<<<<<<<<<<<<<<<<
    });
}
function $07e5e03ce19a9429$export$f0abfad23975ce08() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    const rcc = (0, $ba5c5d811afd797b$export$2a9fee5f37bfd138)(ringClock); // ringClockCenter {x, y}
    ...
    if (CRapp.jwstStatus === true) {
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX3Downer");
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("exitTask", 0.3);
        (0, $ba5c5d811afd797b$export$347205875fe8a919)();
        $07e5e03ce19a9429$var$jwstImageExitAnimation();
        (0, $ba5c5d811afd797b$export$d620722169cc0b8f)("normal");
        (0, $ba5c5d811afd797b$export$6257e3bc44d03c80)("normal");
        ...
        $07e5e03ce19a9429$var$stopTargetScan();
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("shortRandomBeep", 0, 0, 0, 0.5);
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("executing", 0.15, 0, 0, 0.4);
        // prep init ====
        ...
        targetStar.style.opacity = 0;
        // home ui adjustments
        (0, $ba5c5d811afd797b$export$6257e3bc44d03c80)("minimized");
        (0, $ba5c5d811afd797b$export$d620722169cc0b8f)("minimized");
        // animate ringClock
        ...
        $07e5e03ce19a9429$var$jwstImageEnterAnimation();
    }
}
function $07e5e03ce19a9429$export$63951974ec882883(huggy) {
    (0, $ba5c5d811afd797b$export$c9e8cccd464b5a6c)(huggy); // can't set it during ui init because huggy is set to display=none via css for safe guarding
    huggy.style.opacity = 0.35;
    huggy.setAttribute("fill", "#fff");
    (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(huggy, "blink2");
    ...
    d3.select(huggy).transition().delay(500).duration(1000).ease(d3.easeCubicOut).on("start", ()=>{
        ...
        (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("you’ve found the  " + obfuscatingText1 + " o " + obfuscatingText2 + " l " + obfuscatingText2 + " ! !  " + "Con" + String.fromCharCode(103) + "rats ~"); // = "you've found the K o a l a ! ! Congrats ~""
    }).attr("transform", "scale(2)").on("end", ()=>{
        (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("A l l   h a i l   t h e   g r e a t    " + obfuscatingText1 + " o " + obfuscatingText2 + " l " + obfuscatingText2 + "  ! ! ! ! !") // = "All hail the great Koala ! ! ! ! !"
        ;
...
function $69b0669fe3c942c8$export$ac98d773e506b9d(force) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    if (CRapp.bufferTimeStatus) {
        // turning effects ON
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("warningHigh", 0, 0, 0, 0.6);
        ...
        ring3.style.strokeDashoffset = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(-6000, 6000); // random init ring rotation
        ring4.style.strokeDashoffset = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(-6000, 6000);
        const extraTicks = 1;
        ...
        CRapp.bufferTimeTimer = setInterval(()=>{
            ...
            // * update number text
            const displayedNumber = (0, $08b51f3f4a82ba06$export$dd918e842b943f50)(countdownNum, 2);
            ...
            if (CRapp.bufferTimeCountdown == 60) {
                if (extraTicksRemaining == extraTicks) (0, $dab718e507db4475$export$80cb197f7ea4fe13)("executing");
            } else if (CRapp.bufferTimeCountdown >= 16) {
                const newVolume = 1 - CRapp.bufferTimeCountdown / 60 * .82;
                if (CRapp.bufferTimeCountdown % 10 == 0) (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX3Upper", 0, 0, 0, newVolume);
                else (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX1Down", 0, 0, 0.08, Math.max(newVolume, 0.6));
            } else {
                let blinkClass;
                if (CRapp.bufferTimeCountdown >= 6) {
                    blinkClass = "blink1";
                    (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX1Up");
                } else if (CRapp.bufferTimeCountdown >= 1) {
                    blinkClass = "blink2";
                    (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Up");
                } else {
                    blinkClass = "blink3";
                    (0, $dab718e507db4475$export$80cb197f7ea4fe13)((0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                        "processing",
                ...
                if (CRapp.bufferTimeCountdown < 1) {
                    ...
                    ring3.style.strokeDashoffset = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(-6000, 6000);
                    ring4.style.strokeDashoffset = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(-6000, 6000);
                }
            ...
            if (countdownNum % 10 == 0) (0, $ba5c5d811afd797b$export$915e86dc1242cd73)(`${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)(warningTextPrefix)} • No Buffer Time granted${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)(warningTextPostfix)}`, "timePrefix");
            if (extraTicksRemaining > 0) extraTicksRemaining--;
            else --CRapp.bufferTimeCountdown;
        }, 1000);
    } else {
        // turning effects OFF
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("exitTask");
        ...
        (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("Buffer Time Quota Restored", "timePrefix");
    }
}
...
function $a3fa443dc43c17c1$var$toggleYouTubeMenu(force, mute = null) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    let toShowMenu;
    ...
    if (toShowMenu) {
        ...
        if (mute !== "mute") (0, $dab718e507db4475$export$80cb197f7ea4fe13)("notification", 0, 0, 0, 0.25);
    } else {
        delete document.documentElement.dataset.ytMenu;
        if (mute !== "mute") (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Downer", 0, 0, 0, 0.3);
    }
}
/**
 ...
 */ function $a3fa443dc43c17c1$var$addYouTubeVideo(ytMediaId) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    $a3fa443dc43c17c1$var$endYouTubeVideo("mute");
    (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("YouTube Channel Opened: Establishing connection...");
    const ytRect = $a3fa443dc43c17c1$export$365bebd2e24b0755();
    ...
    $a3fa443dc43c17c1$var$toggleYouTubeMenu(false);
    (0, $dab718e507db4475$export$80cb197f7ea4fe13)("processing", 0.15, 0.3, 0, 0.2);
}
function $a3fa443dc43c17c1$export$365bebd2e24b0755(dest = null) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    let destPlaceholder;
    let toDest;
...
function $a3fa443dc43c17c1$export$1f03644a907fa072() {
    const iframe = document.getElementById("ytIframe2");
    if (iframe != null) iframe.classList.add("hide");
}
function $a3fa443dc43c17c1$export$835fa8e7389197b5() {
    const iframe = document.getElementById("ytIframe2");
    if (iframe != null) iframe.classList.remove("hide");
}
function $a3fa443dc43c17c1$var$endYouTubeVideo(mute = null) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    // hard reset
    ...
    $a3fa443dc43c17c1$var$toggleYouTubeMenu(false, "mute");
    if (mute !== "mute") {
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("exitTask", 0, 0, 0, 0.6);
        (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("YouTube Video Window Terminated As Requested");
    }
}
function $a3fa443dc43c17c1$export$1036761be95cb4cc() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    textInput.addEventListener("keyup", (event)=>{
        if (event.key === "Enter") {
            let videoId = $a3fa443dc43c17c1$var$youTubeGetID(textInput.value.trim());
            if (videoId.length > 0) $a3fa443dc43c17c1$var$addYouTubeVideo(videoId);
        }
    });
    CRapp.homeContentDom.querySelector('[id^="btnS47Menu"]').onpointerdown = ()=>{
        $a3fa443dc43c17c1$var$toggleYouTubeMenu();
    };
    CRapp.homeContentDom.querySelector('[id^="btnS47End"]').onpointerdown = ()=>{
        $a3fa443dc43c17c1$var$endYouTubeVideo();
    };
    ...
    CRapp.homeContentDom.querySelector('[id^="ytMenu"]').onpointerdown = (e)=>{
        ...
        if (btnId.includes("btnS47Yt6")) {
            ...
            // videoId = 'SliBmD29dqY';
            videoId = $a3fa443dc43c17c1$var$youTubeGetID(textInput.value.trim());
        ...
        if (videoId !== null) $a3fa443dc43c17c1$var$addYouTubeVideo(videoId);
    };
...
function $a3fa443dc43c17c1$var$youTubeGetID(url) {
    url = url.split(/(vi\/|v%3D|v=|\/v\/|youtu\.be\/|\/embed\/)/);
    return undefined !== url[2] ? url[2].split(/[^0-9a-z_\-]/i)[0] : url[0];
}


function $4024e26eb017430a$export$57f76693a5823e7b() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    (0, $5d1043473d96ae14$export$1ea5135a72d2338a)();
    (0, $5d1043473d96ae14$export$66453c7132c7178e)(CRapp.homeContentDom.querySelector("#homeClock tspan"), CRapp.homeContentDom.querySelector("#homeDate tspan"), "hasRingClock");
    // setup log display
    CRapp.logPlaceholderDom = CRapp.homeContentDom.querySelector("#log_placeholder");
    (0, $ba5c5d811afd797b$export$140a85b3298067e4)();
    ...
    (0, $ba5c5d811afd797b$export$51e541a0222a493e)();
    ...
    (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Downer", .15, 0, 0, 0.3);
    d3.select(CRapp.homeFrameDom.querySelector("#topLeftCorner")).style("opacity", 1).transition().delay(200).duration(200).on("start", function() {
        ...
        (0, $08b51f3f4a82ba06$export$275509f970718c8a)(CRapp.pageTimers, ()=>{
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX1Down", .55);
        ...
        homeBtns.forEach((element)=>{
            (0, $08b51f3f4a82ba06$export$275509f970718c8a)(CRapp.pageTimers, ()=>{
                element.style.transition = `opacity ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(-100, 1200)}ms ease ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(0, 200)}ms`;
                element.style.opacity = 1;
            }, (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(0, 600));
        });
        (0, $08b51f3f4a82ba06$export$275509f970718c8a)(CRapp.pageTimers, ()=>{
        ...
        //* fade-in time & date
        (0, $08b51f3f4a82ba06$export$275509f970718c8a)(CRapp.pageTimers, ()=>{
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("negative", 0, 0, 0, 0.5);
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("longTaskLow");
        // ! Page STATUS ================ 'home'  <-> 'transitioning'  <->   'ship'
        ...
        ringClock.style.transform = `${rccTa} rotate(${(0, $08b51f3f4a82ba06$export$a13251365167ea49)() * (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(15, 50)}deg)  scale(0.5) ${rccTb}`;
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX3Downer", 0, 0, 0, 0.5);
        (0, $08b51f3f4a82ba06$export$275509f970718c8a)(CRapp.pageTimers, ()=>{
        ...
        (0, $08b51f3f4a82ba06$export$275509f970718c8a)(CRapp.pageTimers, ()=>{
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("processing", 0, 0, 0, 0.3);
            ...
            (0, $08b51f3f4a82ba06$export$275509f970718c8a)(CRapp.pageTimers, ()=>{
                ...
                (0, $dab718e507db4475$export$80cb197f7ea4fe13)("shortRandomBeep", .25, 0, 0, 0.3);
                (0, $dab718e507db4475$export$80cb197f7ea4fe13)("notification", 1, 0, 0, 0.5);
            }, 1000);
        }, 1500);
        ...
        (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("LD LCARS is ready", "timePrefix");
    }).on("end", function() {
    // ! Page STATUS ================ 'home'  <-> 'transitioning'  <->   'ship'
    // CRapp.pageStatus = 'home';
    }).on("cancel interrupt", ()=>{
...
function $4024e26eb017430a$export$2cb9f69ba224823a() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    if (CRapp.pageStatus == "transitioning") return;
    // ! Page STATUS ================ 'home'  <-> 'transitioning'  <->   'ship'
    CRapp.pageStatus = "transitioning";
    ...
    CRapp.pageTimers = [];
    (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("switching to LD Main screen", "timePrefix");
    (0, $5d1043473d96ae14$export$1ea5135a72d2338a)();
    (0, $5d1043473d96ae14$export$66453c7132c7178e)(CRapp.homeContentDom.querySelector("#homeClock tspan"), CRapp.homeContentDom.querySelector("#homeDate tspan"), "hasRingClock");
    ...
    (0, $a3fa443dc43c17c1$export$1f03644a907fa072)();
    // * animation starting...........
    // * ====================================================================
    // *
    (0, $ba5c5d811afd797b$export$51e541a0222a493e)();
    d3.select(CRapp.shipFrameDom.querySelector("#shipMainTopLeftCorner")).transition("main").duration(400).on("start", ()=>{
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("warningLow", 0, 0, 0, 0.6);
        //*  ship fading out
        ...
        (0, $6fdf0ffb4a84c329$export$71d9d5af3ae909a7)();
        // if (CRapp.shipZoomMode) shipFullViewReset();
        (0, $6fdf0ffb4a84c329$export$8a2e6fed9df8c3ad)(); // ! <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("negative", 0, 0.2, 0, 0.25, 1.1);
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("executing", 0, 0.4, 0, 0.3);
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("exitTask", 0, 0, 0, 0.4, 1.2); //* earlier start to sync up Sliding of the shipConfig window
    }).on("end", ()=>{
        ...
        CRapp.shipContentDom.style.opacity = 0;
        CRapp.shipContentDom.style.visibility = "hidden";
        (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("LD Main screen loaded", "timePrefix");
    }).on("end", ()=>{
        ...
        (0, $a3fa443dc43c17c1$export$365bebd2e24b0755)("home");
        (0, $a3fa443dc43c17c1$export$835fa8e7389197b5)();
...
function $4024e26eb017430a$export$304b0864fb001794() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    if (CRapp.pageStatus == "transitioning") return;
    ...
    CRapp.pageTimers = [];
    if (CRapp.jwstStatus) (0, $07e5e03ce19a9429$export$f0abfad23975ce08)();
    // turn buffer time off first before stopping clock... because when buffer time ends it triggers clock to start again
    if (CRapp.bufferTimeStatus) (0, $69b0669fe3c942c8$export$ac98d773e506b9d)();
    (0, $5d1043473d96ae14$export$1ea5135a72d2338a)();
    (0, $5d1043473d96ae14$export$66453c7132c7178e)(document.querySelector("#msdContainer > svg #shipClock tspan"), null, "noRingClock");
    ...
    (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("Switching to USS Cerritos MAP", "timePrefix");
    //* pre SHIP elements
    ...
    (0, $ba5c5d811afd797b$export$54be3cd0bd47bcf0)();
    // ! temp hiding YouTube video node until new dest  === Y Y Y Y Y Y Y Y Y Y Y Y Y Y Y Y Y Y Y Y Y
    (0, $a3fa443dc43c17c1$export$1f03644a907fa072)();
    // semi fade hide title text
    CRapp.homeFrameDom.querySelector("#frameTitleText").style.opacity = 0.4;
    (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Downer", 0, 0, 0, 0.8);
    ...
    .on("start", ()=>{
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("shortRandomBeep", 0, 0, 0, 0.3);
    }).on("end", ()=>{
        // hide home clock
        ...
        //* 
        (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("loading MSD / Master System Display", "timePrefix");
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("affirmative", 0, 0, 0, 0.3);
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("warningHigh", 0, 0, 0, 0.2);
    }).on("end", ()=>{
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX3Down", 0, 0, 0, 0.3);
    }).on("end", ()=>{
        ...
        (0, $ba5c5d811afd797b$export$140a85b3298067e4)(); // this function uses param from CRapp.pageState. So set it after pageState has been updated
        // fade in config box with logs
        CRapp.shipFrameDom.querySelector("#frameShipConfig").style.opacity = 1;
        CRapp.logDisplayDom.style.opacity = 1;
        CRapp.logDisplayDom.style.visibility = "visible";
        CRapp.logDisplayDom.style.opacity = 1;
        (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("USS Cerritos MSD loading complete", "timePrefix");
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("exitTask", 0.2, 0, 0, 0.4);
    }).transition("main").delay(600).duration(1000).on("start", ()=>{
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("powerUp", 0, 0.35, 0, 0.5, (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            1.3,
            1.4,
            0.85
        ...
        (0, $6fdf0ffb4a84c329$export$f254544244e1cd1a)(); // ! <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        // * unhide YouTube iframe
        (0, $a3fa443dc43c17c1$export$365bebd2e24b0755)("ship");
        (0, $a3fa443dc43c17c1$export$835fa8e7389197b5)();
    }).on("end", ()=>{
        // * reveal the With-In-Frame BTNs, via css transition with delay
        CRapp.shipFrameDom.querySelector("#shipMsdBtns").style.opacity = 1;
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("shortRandomBeep", 0, 0, 0, 0.3);
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Up", 0.4, 0, 0, 0.1);
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX3Downer", 0.8, 0, 0, 0.2);
        ...
        (0, $d7e982942b5ab808$export$1eb886acfb38646b)();
        // ! Page STATUS ================ 'home'  <-> 'transitioning'  <->   'ship'
...
function $221d85e6cc58a701$export$30d8a1cfcadf29b() {
    ...
    if ((0, $08b51f3f4a82ba06$export$fedb369cb70207f1)()) return;
    if (document.fullscreenEnabled || document.webkitFullscreenEnabled) {
        ...
        btnFullscreen.addEventListener("pointerdown", (e)=>{
            $221d85e6cc58a701$export$a25ea78e22395c66();
            e.stopPropagation();
        });
...
function $221d85e6cc58a701$export$a25ea78e22395c66() {
    if (document.fullscreenElement) document.exitFullscreen().then(()=>{
        $221d85e6cc58a701$var$fullscreenExited();
    }).catch((err)=>{
        console.error(err);
    });
        ...
        if (document.fullscreenEnabled) {
            ...
            $221d85e6cc58a701$var$fullscreenStarted();
        } else if (document.webkitFullscreenEnabled) {
            document.documentElement.webkitRequestFullscreen();
            $221d85e6cc58a701$var$fullscreenStarted();
        } else {
            const tmpString = "Sorry. Fullscreen mode is not available on this device.";
            (0, $ba5c5d811afd797b$export$915e86dc1242cd73)(tmpString);
            console.log(tmpString);
        }
    }
}
function $221d85e6cc58a701$var$fullscreenStarted() {
    document.documentElement.dataset.fullscreen = "on";
    // console.log("- fullscreen mode on");
    $221d85e6cc58a701$var$outputFullscreenLog(true);
    (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX3Upper", 0, 0, 0, 0.8);
}
function $221d85e6cc58a701$var$fullscreenExited() {
    delete document.documentElement.dataset.fullscreen;
    // console.log("- fullscreen mode exited");
    $221d85e6cc58a701$var$outputFullscreenLog(false);
    (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Downer", 0, 0, 0, 0.8);
}
function $221d85e6cc58a701$var$outputFullscreenLog(fullscreenResult) {
    if (fullscreenResult === true) (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("Full screen mode is now enabled • Press <ESC> to Exit");
    else if (fullscreenResult === false) (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("Exited Full screen mode <CTRL+SHIFT+F>");
}
...
function $fe3d05c3bcaea3ea$export$3851b34a6f183e48() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    $fe3d05c3bcaea3ea$export$aac5c958cc8264ab("fetchStatus", {
...
function $fe3d05c3bcaea3ea$export$7f0366e849f5576a() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
...
function $fe3d05c3bcaea3ea$export$aac5c958cc8264ab(eventType, data, callback) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    if (!CRapp.serverApiConnection) return;
 ...
 */ window.processServerEvent = function(eventType, data = {}) {
    ...
    if (eventTypeLowerCase == "updateState".toLowerCase() || eventTypeLowerCase == "responseToFetchStatus".toLowerCase()) {
        ...
        if ("colorSchemeName" in data) {
            const success = (0, $ba5c5d811afd797b$export$878a77c0bab57c97)(data.colorSchemeName);
            if (success) (0, $13e995fcd4f68ee5$export$731cb1e997115006)("colorSchemeName", data.colorSchemeName);
        }
        // change ALERT status ==============================================
        if ("alertStatus" in data) {
            if (data["alertStatus"].toLowerCase() == "red") {
                ...
                if (CRapp.redAlertStatus) console.log("Already in Red Alert. Alert status not changed.");
                    ...
                    (0, $ba5c5d811afd797b$export$27a97e56ea376f1e)(null, "NotUpdatingServer");
        ...
        // change SHIP INFO ===================
        if ("shipName" in data) (0, $ba5c5d811afd797b$export$f7d3c41002dae854)("shipName", data.shipName);
        if ("shipClass" in data) (0, $ba5c5d811afd797b$export$f7d3c41002dae854)("shipClass", data.shipClass);
        if ("shipRegistry" in data) (0, $ba5c5d811afd797b$export$f7d3c41002dae854)("shipRegistry", data.shipRegistry);
        ...
        if (outputString.length > 0) (0, $ba5c5d811afd797b$export$915e86dc1242cd73)(outputString);
        if (typeof temperature == "number") (0, $ba5c5d811afd797b$export$915e86dc1242cd73)(`Current temperature is ${temperature.toFixed(1)}°C`, "timePrefix");
        ...
        if (message.trim().length > 0) {
            (0, $ba5c5d811afd797b$export$915e86dc1242cd73)(message, showTimePrefix ? "timePrefix" : null);
            if (toPlaySound) (0, $dab718e507db4475$export$80cb197f7ea4fe13)((0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                "affirmative",
                "awaiting"
            ]), 0, 0, 0, 0.6);
        }
...
function $ba5c5d811afd797b$export$b6b0e127fc71cc83() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    $ba5c5d811afd797b$export$72eabe1fd7b85356(); // replace design colors to css classes
    ...
    const pbc = $ba5c5d811afd797b$export$5f3b35c2b8474baf(shipPointerBlocker);
    ...
    CRapp.configContentDom.querySelector("#configBtns").onpointerdown = (e)=>{
        ...
        if (tmpId.indexOf("btn0") == 0) $ba5c5d811afd797b$export$f4ac3bcd1bdb936d();
        else if (tmpId.indexOf("btn1a") == 0) {
            $ba5c5d811afd797b$export$5cff1c8d974e3f0b();
            (0, $13e995fcd4f68ee5$export$731cb1e997115006)("bgHue", CRapp.bgHue);
        } else if (tmpId.indexOf("btn1b") == 0) {
            $ba5c5d811afd797b$export$1bda2b6d3dd4d993();
            (0, $13e995fcd4f68ee5$export$731cb1e997115006)("bgLevel", CRapp.bgLevel);
        } else if (tmpId.indexOf("btn2") == 0) {
            const result = $ba5c5d811afd797b$export$6b9b218407705316();
            (0, $13e995fcd4f68ee5$export$731cb1e997115006)("softVignette", result);
        } else if (tmpId.indexOf("btn3") == 0) {
            const result1 = $ba5c5d811afd797b$export$4a4f808287652e93();
            (0, $13e995fcd4f68ee5$export$731cb1e997115006)("ldGlare", result1);
        }
    };
    ...
    const ringClock = CRapp.homeContentDom.querySelector("#ringClock");
    const rcc = $ba5c5d811afd797b$export$5f3b35c2b8474baf(ringClock);
    // ! use transform on "style", not to "attribute" so that it can be transitioned nice on all major browsers
    const rccTa = `translate(${rcc.x}px, ${rcc.y}px)`; // !!! << need "px"
    const rccTb = `translate(-${rcc.x}px, -${rcc.y}px)`;
    ringClock.style.transform = `${rccTa} rotate(${(0, $08b51f3f4a82ba06$export$a13251365167ea49)() * (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(250, 380)}deg) scale(0.7) ${rccTb}`;
    ...
    (0, $a3fa443dc43c17c1$export$1036761be95cb4cc)();
    // home Clock
    ...
    CRapp.shipContentDom.querySelectorAll('[id^="bussardGasAni"]').forEach((node, index)=>{
        node.style.animationDuration = (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(6, 14).toFixed(1) + "s";
    });
    //* build number in ship's config <<<<<<<<<<<
    CRapp.shipFrameDom.querySelector('[id^="buildVersion"] tspan').textContent = `BUILD • ${CRapp.revisionDate}`;
    $ba5c5d811afd797b$export$5f3b35c2b8474baf(document.querySelector("#msdContainer svg #contentShip"));
    // BTNS // ON the ship Frame
    CRapp.shipFrameDom.querySelector('#shipFrame1c [id^="btn1"]').onpointerdown = ()=>{
        (0, $6fdf0ffb4a84c329$export$867e02d6ef0e904)();
    };
    CRapp.shipFrameDom.querySelector('#shipFrame1c [id^="btn2"]').onpointerdown = (e)=>{
        ...
        if (pointerDownX <= 37) (0, $6fdf0ffb4a84c329$export$b9bb69d98eff82dd)("hit_engineeringHull");
        else if (pointerDownX >= 41 && pointerDownX <= 66) (0, $6fdf0ffb4a84c329$export$b9bb69d98eff82dd)("hit_starboardNacelle");
        else if (pointerDownX >= 70) (0, $6fdf0ffb4a84c329$export$b9bb69d98eff82dd)("hit_saucerModule");
    };
    CRapp.shipFrameDom.querySelector('#shipFrame1c [id^="btn3"]').onpointerdown = ()=>{
        (0, $6fdf0ffb4a84c329$export$203cdef525f5b26e)();
    };
    ...
    CRapp.shipFrameDom.querySelector('#shipMsdBtns [id^="btn1"]').onpointerdown = ()=>{
        (0, $fb2f4fe51f80d60c$export$543099fd07e5174b)();
    };
    CRapp.shipFrameDom.querySelector('#shipMsdBtns [id^="btn2"]').onpointerdown = ()=>{
        (0, $8fa320b0760973ea$export$53b47a456413a20)();
    };
    ...
    (0, $fb2f4fe51f80d60c$export$db11f0672e3c0cc0)();
    //* ############################################################################
    ...
    const tmpO = $ba5c5d811afd797b$export$73569430680496de(bufferTimeText);
    CRapp.bufferTimeTextOrigin = $ba5c5d811afd797b$export$73569430680496de(bufferTimeText);
    ...
    for(let i = 0; i <= 60; i++){
        bufferTimeTextTspan.textContent = (0, $08b51f3f4a82ba06$export$dd918e842b943f50)(i, 2); // feed in the number with 2 digits
    ...
    $ba5c5d811afd797b$export$5f3b35c2b8474baf(ritosTop);
    ...
    ritosTop.onpointerdown = ()=>{
        (0, $d7e982942b5ab808$export$1eb886acfb38646b)();
        (0, $d7e982942b5ab808$export$8e0e260f5562ebea)();
    };
    ...
    ritosFront.onpointerdown = ()=>{
        (0, $d7e982942b5ab808$export$a3c8ae47def8917d)();
    };
    //* ------ BRACKETS WINDOW
    // const bracketsWindow = document.querySelector('#msdContainer2 > svg #bracketsWindow');    
    ...
    const rac = $ba5c5d811afd797b$export$5f3b35c2b8474baf(redAlertSymbol);
    // ! use transform on "style", not to "attribute" so that it can be transitioned nice on all major browsers
    ...
    huggy.onpointerdown = ()=>{
        (0, $07e5e03ce19a9429$export$63951974ec882883)(huggy);
    };
    // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    CRapp.homeFrameDom.querySelector("#homeBtn1a").onpointerdown = ()=>{
        if (CRapp.pageStatus !== "transitioning") (0, $4024e26eb017430a$export$304b0864fb001794)();
    };
    document.getElementById("btnShipToHome").onpointerdown = ()=>{
        if (CRapp.pageStatus !== "transitioning") (0, $4024e26eb017430a$export$2cb9f69ba224823a)();
    };
    //* page routing btns =========================================
    // * ########## MAIN BTNs
    document.getElementById("homeBtn1b").onpointerdown = ()=>{
        if (CRapp.pageStatus !== "transitioning") (0, $07e5e03ce19a9429$export$f0abfad23975ce08)();
    };
    document.getElementById("homeBtn1c").onpointerdown = ()=>{
        if (CRapp.pageStatus !== "transitioning") (0, $69b0669fe3c942c8$export$ac98d773e506b9d)();
    };
    document.getElementById("homeBtn1d").onpointerdown = ()=>{
        if (CRapp.pageStatus !== "transitioning") $ba5c5d811afd797b$export$27a97e56ea376f1e();
    };
    document.getElementById("homeBtn1e").onpointerdown = ()=>{
        $ba5c5d811afd797b$export$44ae1f4c32a29f68();
    };
    // * ========= ABOUT PAGE
    ...
    CRapp.shipFrameDom.querySelector("#frameShipConfig").onpointerdown = (e)=>{
        ...
        if (id.indexOf("btnLogs") == 0) {
            $ba5c5d811afd797b$export$9d6e39bfd8070d15("logs");
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX1Down", 0, 0, 0, 0.5);
        } else if (id.indexOf("btnConfigs") == 0) {
            $ba5c5d811afd797b$export$9d6e39bfd8070d15("configs");
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Up", 0, 0, 0, 0.4);
        } else if (id.indexOf("btnAudio") == 0) {
            (0, $dab718e507db4475$export$c8cdacb776d3b001)();
            $ba5c5d811afd797b$export$bdc5a3df8001f263(e.target, "blink2");
        } else if (id.indexOf("btnReset") == 0) $ba5c5d811afd797b$export$fbcfaec45996d1ba();
        else if (id.indexOf("btnBuildVersion") == 0) $ba5c5d811afd797b$export$44ae1f4c32a29f68();
        else if (id.indexOf("btnRedAlert") == 0) {
            if (CRapp.pageStatus !== "transitioning") $ba5c5d811afd797b$export$27a97e56ea376f1e();
        }
    };
    CRapp.homeContentDom.querySelector("#homeClock").onpointerdown = function() {
        (0, $5d1043473d96ae14$export$189cabd35bb0035c)(this);
    };
    CRapp.shipFrameDom.querySelector("#shipClock").onpointerdown = function() {
        (0, $5d1043473d96ae14$export$189cabd35bb0035c)(this);
    };
    (0, $fb2f4fe51f80d60c$export$e26511dac4440c6f)();
    ...
    (0, $6fdf0ffb4a84c329$export$43d4f9696d93e7dd)();
    (0, $8fa320b0760973ea$export$c0676d6c9e7dce11)();
    $ba5c5d811afd797b$export$6556b97061fcd918(); // setup width info
    (0, $067ccd90172917f4$export$12ab491ecc4d1301)(); // init & setup random locations. lifts ani not running yet.
    (0, $6fdf0ffb4a84c329$export$fcfbdb67292ec4e5)(); // init styles
    (0, $6fdf0ffb4a84c329$export$26005a9ab81e8a26)();
    // ! DEV ============================
    // CRapp.stopAni = ()=>{
    ...
    $ba5c5d811afd797b$export$d7b85a0d97268c94();
// DEV =============
...
function $ba5c5d811afd797b$export$57e6a6d9b8e425d7(varName) {
    return getComputedStyle(document.documentElement).getPropertyValue("--" + varName).trim();
}
function $ba5c5d811afd797b$export$72eabe1fd7b85356() {
...
function $ba5c5d811afd797b$export$f4ac3bcd1bdb936d() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    if (CRapp.redAlertStatus) {
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("negative", 0, 0, 0, 0.5);
        $ba5c5d811afd797b$export$915e86dc1242cd73(`unable to comply • red alert in progress`);
        return;
    }
    ...
    $ba5c5d811afd797b$export$f2d00fe8ce80fd84(newColorIndex);
    $ba5c5d811afd797b$export$915e86dc1242cd73(`color scheme <${CRapp.colorSchemeNames[newColorIndex]}> activated`);
    (0, $13e995fcd4f68ee5$export$731cb1e997115006)("colorSchemeName", CRapp.colorSchemeNames[newColorIndex]);
    (0, $fe3d05c3bcaea3ea$export$aac5c958cc8264ab)("setStatus", (0, $fe3d05c3bcaea3ea$export$7f0366e849f5576a)());
}
function $ba5c5d811afd797b$export$f2d00fe8ce80fd84(newIndex = 0) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
...
function $ba5c5d811afd797b$export$878a77c0bab57c97(newColorSchemeName = null) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    const newColorSchemeIndex = CRapp.colorSchemeNames.indexOf(newColorSchemeName);
    if (newColorSchemeIndex != -1) {
        $ba5c5d811afd797b$export$f2d00fe8ce80fd84(newColorSchemeIndex);
        return true;
    } else {
...
function $ba5c5d811afd797b$export$fbcfaec45996d1ba() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX3Up", 0, 0, 0, 0.5);
    (0, $dab718e507db4475$export$80cb197f7ea4fe13)("powerUp", 0, 0, 0, 0.5, 1.3);
    // reset COLOR SCHEME
    ...
    //* cancel RED ALERT
    if (CRapp.redAlertStatus) $ba5c5d811afd797b$export$27a97e56ea376f1e();
    $ba5c5d811afd797b$export$915e86dc1242cd73(`LCARS STYLES RESET COMPLETE`, "timePrefix");
    (0, $13e995fcd4f68ee5$export$731cb1e997115006)("colorSchemeName", CRapp.colorSchemeNames[0]);
    (0, $13e995fcd4f68ee5$export$731cb1e997115006)("bgHue", CRapp.bgHue);
    (0, $13e995fcd4f68ee5$export$731cb1e997115006)("bgLevel", CRapp.bgLevel);
    (0, $13e995fcd4f68ee5$export$731cb1e997115006)("softVignette", true);
    (0, $13e995fcd4f68ee5$export$731cb1e997115006)("ldGlare", true);
    (0, $fe3d05c3bcaea3ea$export$aac5c958cc8264ab)("setStatus", (0, $fe3d05c3bcaea3ea$export$7f0366e849f5576a)());
}
function $ba5c5d811afd797b$export$5cff1c8d974e3f0b(toThisNewBgHue = null) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    if (toThisNewBgHue === null) {
        if (CRapp.colorSchemeNames[CRapp.currentColorScheme].toLocaleLowerCase().includes("blueprint") || CRapp.colorSchemeNames[CRapp.currentColorScheme].toLocaleLowerCase().includes("beige")) {
            $ba5c5d811afd797b$export$915e86dc1242cd73(`BG color cannot be changed with this color scheme`);
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("negative", 0, 0, 0, 0.5);
            return;
        }
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX1Up", 0, 0, 0, 0.4);
    ...
    if (toThisNewBgHue === null) $ba5c5d811afd797b$export$915e86dc1242cd73(`Background Hue set to ${newBgHue}`);
}
function $ba5c5d811afd797b$export$1bda2b6d3dd4d993(toThisNewBgLevel = null) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    if (toThisNewBgLevel === null) {
        if (CRapp.colorSchemeNames[CRapp.currentColorScheme].toLocaleLowerCase().includes("blueprint") || CRapp.colorSchemeNames[CRapp.currentColorScheme].toLocaleLowerCase().includes("beige")) {
            $ba5c5d811afd797b$export$915e86dc1242cd73(`bg level cannot be changed with this color scheme`);
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("negative", 0, 0, 0, 0.5);
            return;
        }
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX3Up", 0, 0, 0, 0.4);
    ...
    CRapp.bgPreBlackLevel = CRapp.bgLevel;
    document.documentElement.style.setProperty("--bgColorLevel", `${CRapp.bgLevel}%`);
    if (toThisNewBgLevel === null) $ba5c5d811afd797b$export$915e86dc1242cd73(`Background Light Level set to ${CRapp.bgLevel}%`);
}
function $ba5c5d811afd797b$export$6b9b218407705316(force = null, noLog = null, mute = null) {
    let setVignetteOn;
    ...
    if (setVignetteOn) {
        document.documentElement.dataset.vignette = "";
        if (noLog !== "noLog") $ba5c5d811afd797b$export$915e86dc1242cd73(`soft vignette mode on`);
        if (mute !== "mute") (0, $dab718e507db4475$export$80cb197f7ea4fe13)("longTaskLow", 0, 1.2, 0, 0.3);
    } else {
        delete document.documentElement.dataset.vignette;
        if (noLog !== "noLog") $ba5c5d811afd797b$export$915e86dc1242cd73(`soft vignette mode off`);
        if (mute !== "mute") (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Upper", 0, 0, 0, 0.3);
    }
    return setVignetteOn;
}
function $ba5c5d811afd797b$export$4a4f808287652e93(force = null, noLog = null, mute = null) {
    let setGlareOn;
    ...
    if (setGlareOn) {
        ...
        if (mute !== "mute") (0, $dab718e507db4475$export$80cb197f7ea4fe13)("exitTask", 0, 0, 0, 0.3);
        ...
        if (rndStyle < 0.33) {
            ...
            let tmpLeft = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(39, 47);
            let tmpWidth = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(53, 67) - tmpLeft;
            div1.style.left = `${tmpLeft}%`;
            div1.style.width = `${tmpWidth}%`;
            tmpLeft = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(69, 76);
            tmpWidth = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(82, 92) - tmpLeft;
            div2.style.left = `${tmpLeft}%`;
            div2.style.width = `${tmpWidth}%`;
        } else {
            let tmpLeft1 = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(39, 47);
            let tmpWidth1 = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(53, 60) - tmpLeft1;
            div1.style.left = `${tmpLeft1}%`;
            div1.style.width = `${tmpWidth1}%`;
            tmpLeft1 = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(62, 76);
            tmpWidth1 = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(82, 92) - tmpLeft1;
            div2.style.left = `${tmpLeft1}%`;
            div2.style.width = `${tmpWidth1}%`;
        }
        document.documentElement.dataset.ldGlare = "";
        if (noLog !== "noLog") $ba5c5d811afd797b$export$915e86dc1242cd73(`Lower Decks Screen Glare mode on`);
    } else {
        delete document.documentElement.dataset.ldGlare;
        if (noLog !== "noLog") $ba5c5d811afd797b$export$915e86dc1242cd73(`Lower Decks Screen Glare mode off`);
        if (mute !== "mute") (0, $dab718e507db4475$export$80cb197f7ea4fe13)("warningLow", 0, 0, 0, 0.3);
    }
    return setGlareOn;
}
function $ba5c5d811afd797b$export$d7b85a0d97268c94() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    ...
    $ba5c5d811afd797b$export$140a85b3298067e4();
    ...
    (0, $a3fa443dc43c17c1$export$365bebd2e24b0755)();
}
function $ba5c5d811afd797b$export$44ae1f4c32a29f68(mute = null) {
    ...
    if (document.documentElement.dataset.about !== undefined) {
        ...
        if (mute !== "mute") (0, $dab718e507db4475$export$80cb197f7ea4fe13)((0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "beepX3Downer",
            "beepX2Downer",
            "beepX1Downer"
        ]), 0, 0, 0, 0.3);
        ...
        if (mute !== "mute") {
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Downer", 0, 0, 0, 0.4);
            (0, $dab718e507db4475$export$80cb197f7ea4fe13)("warningLow", 0.15, 0, 0, 0.3);
        }
    }
}
function $ba5c5d811afd797b$export$140a85b3298067e4() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
...
function $ba5c5d811afd797b$export$5757c822a6ab549a() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    setInterval(()=>{
        ...
        $ba5c5d811afd797b$var$createRandomLog();
...
function $ba5c5d811afd797b$var$createRandomLog() {
    const rndType = (0, $08b51f3f4a82ba06$export$3c5f89dae98e900b)(8);
    let rndText = "";
    let showTimePrefix = false;
    if (rndType == 0) rndText = `${(0, $08b51f3f4a82ba06$export$cc4d98609e3a31e7)(3, 5)} ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)((0, $08b51f3f4a82ba06$export$2f0ee02dbc24ab6e))} • ${(0, $08b51f3f4a82ba06$export$cc4d98609e3a31e7)(2, 4)} ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)((0, $08b51f3f4a82ba06$export$d2eb0d710fd7e6a3))}`;
    else if (rndType == 1) rndText = `Task: ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)((0, $08b51f3f4a82ba06$export$6bc1c44d5e100318))} / ${(0, $08b51f3f4a82ba06$export$cc4d98609e3a31e7)(2, 7)}.${(0, $08b51f3f4a82ba06$export$cc4d98609e3a31e7)(1, 3)} ${(0, $08b51f3f4a82ba06$export$cc4d98609e3a31e7)(2, 4)}`;
    else if (rndType == 2) rndText = `${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
        "Ensign",
        "Lt."
    ])} ${(0, $08b51f3f4a82ba06$export$cc4d98609e3a31e7)(4)}: ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)((0, $08b51f3f4a82ba06$export$6bc1c44d5e100318))} ${(0, $08b51f3f4a82ba06$export$cc4d98609e3a31e7)(2, 4)}`;
    else if (rndType == 3) {
        showTimePrefix = true;
        rndText = `${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)((0, $08b51f3f4a82ba06$export$d2eb0d710fd7e6a3))} ${(0, $08b51f3f4a82ba06$export$cc4d98609e3a31e7)(2, 4)} - ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)((0, $08b51f3f4a82ba06$export$d2eb0d710fd7e6a3))} ${(0, $08b51f3f4a82ba06$export$cc4d98609e3a31e7)(2, 4)}`;
    } else if (rndType == 4) {
        const tmpRnd1 = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(9, 19);
        rndText = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            `Current Heading: Starbase 80 • for ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                "crew exchange",
            ...
            `${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                ...
                "Blueberry",
                "Raspberry"
            ])} Pie Eating Contest in ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2, 7)} days. Prize: A ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                "brand new",
                "slightly used"
            ])} ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                "Padd",
            ...
            `Upcoming assignment: Holodeck ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 4)} waste removal`,
            `carbon filter maintenance on deck ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 13)} • section ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(11, 29)}`,
            `${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                "PLASMA LEAK",
                "COOLANT LEAK",
                "ELEVATED TEMP.",
                "DECONTAMINATION"
            ])} IN JEFFERIES TUBE ON DECK ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(3, 13)} JUNCTIONS ${tmpRnd1}-${tmpRnd1 + 3}`
        ]);
    } else if (rndType == 5) rndText = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
        ...
        `Reminder: Anomaly consolidation duty in ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2, 12)} hours`,
        `Warning • Water leak on deck 11 below the Cetacean Ops`,
        `Alert: Cosmic Koala has been spotted by ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "Ensign",
            "Lt Junior"
        ])} ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "Mitchell",
        ...
        const tmpRnd2 = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2, 7);
        rndText = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            `Turboshaft lubing required between deck ${tmpRnd2} & deck ${tmpRnd2 + (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 6)} S•${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2, 20)}`,
            `duty call: Post Anomaly cleanup on deck ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2, 13)} section ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(10, 36)}`,
            `TRANSPORTER ROOM ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 5)} ${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
                "CURRENTLY IN USE",
                "REPAIRMENT NEEDED",
                "UNDER MAINTENANCE",
            ...
            `Space news: Okudagram version 2383 beta ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2, 13)} testing underway`
        ]);
    } else {
        const rndType2 = (0, $08b51f3f4a82ba06$export$3c5f89dae98e900b)(5);
        if (rndType2 == 0) rndText = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
        ...
        ]) + ": " + (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(70, 100) + "%";
        else if (rndType2 == 1) rndText = "TIME REMAINING ON LEVEL " + (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 5) + " DIAGNOSTIC: ≈ " + (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(0, 5) + "HR " + (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(2, 59) + "MIN";
        else if (rndType2 == 2) rndText = "ANOMALY DETECTED INSIDE HOLODECK " + (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 3) + " >> " + (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "BADGEY 2.0",
            "SUPER KNICK KNACK",
            "HOLO M.McMAHAN",
            "A FUNCTIONAL TOILET",
        ...
        else if (rndType2 == 3) rndText = "WARNING • " + (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            `turbolift ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(1, 5)}`,
            `replicator A${(0, $08b51f3f4a82ba06$export$cc4d98609e3a31e7)(2)}`
        ]) + " TEMPORARILY INOPERABLE";
        else rndText = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(17, 47) + " SUBSPACE FREQUENCIES " + (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
            "ESTABLISHED",
            "DETECTED",
            "MONITORED",
            "LOGGED",
    ...
    $ba5c5d811afd797b$export$915e86dc1242cd73(rndText, showTimePrefix ? "timePrefix" : null);
}
function $ba5c5d811afd797b$export$347205875fe8a919() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    CRapp.logPinned = false;
}
function $ba5c5d811afd797b$export$915e86dc1242cd73(logText = " ", timePrefix = null, pinningRequest = null) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    CRapp.mostRecentLogTime = performance.now();
    const logTextOutput = timePrefix === "timePrefix" ? `${(0, $08b51f3f4a82ba06$export$1428f42a7de81803)()} • ${logText}` : logText;
    ...
    (0, $5d1043473d96ae14$export$9504c7d42aa1dd15)();
    // CLEAN UP span tag
...
function $ba5c5d811afd797b$export$9d6e39bfd8070d15(toShow = "logs") {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    const blinkClassStyle = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)([
        "blink1",
        "blink2"
    ]);
    if (toShow == "logs") {
...
function $ba5c5d811afd797b$export$51e541a0222a493e() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    CRapp.bubbleTextTimer = setInterval(()=>{
        CRapp.homeContentDom.querySelectorAll('[id^="bubbleText1"]').forEach((element)=>{
            if (Math.random() < .3) element.setAttribute("stroke-dashoffset", (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(-450, 450));
            if (Math.random() < .3) element.setAttribute("stroke-dasharray", `${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(20, 250)} ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(20, 120)} ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(20, 250)} ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(20, 120)} ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(20, 250)} ${(0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(20, 120)}`);
            if (Math.random() < .3) element.setAttribute("stroke", `var(--${(0, $08b51f3f4a82ba06$export$de12a21935b7f164)(CRapp.allColorCssVarNames)})`);
            element.style.transitionDelay = (0, $08b51f3f4a82ba06$export$24d4d9f7cb1f68df)(-300, 900) + "ms"; // so that not all animation seem to start at the same time
            if (Math.random() < .2) element.classList.add("blink2");
            else element.classList.remove("blink2");
            element.style.opacity = (0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(0.3, 1);
        });
    }, 1700);
}
function $ba5c5d811afd797b$export$54be3cd0bd47bcf0() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    clearInterval(CRapp.bubbleTextTimer);
    CRapp.bubbleTextTimer = null;
}
function $ba5c5d811afd797b$var$redAlertWarningLogs() {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    $ba5c5d811afd797b$export$915e86dc1242cd73("• A l e r t •");
    CRapp.redAlertTimer2 = setTimeout(()=>{
        $ba5c5d811afd797b$export$915e86dc1242cd73(`• • A\u2002 l\u2002 e\u2002 r\u2002 t • •`);
        CRapp.redAlertTimer2 = setTimeout(()=>{
            $ba5c5d811afd797b$export$915e86dc1242cd73(`• • • T h i s\u2002 i s\u2002 \u2002 R\u2002 e\u2002 d \u2002 \u2002 A\u2002 l\u2002 e\u2002 r\u2002 t • • •`);
        }, 1500);
    }, 1200);
}
function $ba5c5d811afd797b$export$27a97e56ea376f1e(force, updatingServer = "updatingServer") {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    CRapp.redAlertStatus = !CRapp.redAlertStatus;
    if (CRapp.redAlertStatus) {
        // turning effects ON
        document.documentElement.dataset.redAlert = "";
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("startRedAlert");
        ...
        // start warning logs ========
        $ba5c5d811afd797b$export$915e86dc1242cd73("W a r n i n g", "timePrefix");
        CRapp.redAlertTimer2 = setTimeout(()=>{
            $ba5c5d811afd797b$var$redAlertWarningLogs();
        }, 1000);
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("stopRedAlert");
        ...
        $ba5c5d811afd797b$export$915e86dc1242cd73("Alert Status: Normal", "timePrefix");
    }
...
function $ba5c5d811afd797b$export$6257e3bc44d03c80(force = null) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    const configNode = CRapp.svg1.querySelector("#homeConfig");
    ...
    if (sizingTo == "minimized") {
        ...
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("shortRandomBeep", 0, 0, 0, 0.3);
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("warningLow", 0.65, 0, 0, 0.5);
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("beepX2Up", 1.3, 0, 0, 0.3);
...
function $ba5c5d811afd797b$export$d620722169cc0b8f(force = null) {
    const CRapp = (0, $10cf9956fee6f4c6$export$fd6634b1b91dc17e)();
    const homeClock = CRapp.svg1.querySelector("#homeClock");
...
function $ba5c5d811afd797b$export$73569430680496de(node) {
...
function $ba5c5d811afd797b$export$c9e8cccd464b5a6c(node1, nodeCenter = null) {
    let centerBox;
...
function $ba5c5d811afd797b$export$5f3b35c2b8474baf(node1, nodeCenter = null) {
    let centerBox;
    if (nodeCenter !== null) centerBox = nodeCenter.getBBox();
    else centerBox = node1.getBBox();
...
function $ba5c5d811afd797b$export$2a9fee5f37bfd138(node) {
    return {
        x: Number(node.dataset.transformOriginX),
        y: Number(node.dataset.transformOriginY)
    };
}
function $ba5c5d811afd797b$var$removeBlinkClasses(node) {
    node.classList.remove("blink1", "blink2", "blink3");
}
function $ba5c5d811afd797b$export$bdc5a3df8001f263(node, blinkType = "random") {
    if (node == null) {
    ...
    if (blinkType == "random") blinkType = (0, $08b51f3f4a82ba06$export$de12a21935b7f164)(blinkTypes);
    $ba5c5d811afd797b$var$removeBlinkClasses(node);
    setTimeout(()=>{
...
function $ba5c5d811afd797b$export$f681ad6169264fc7() {
    const rnd = Math.random();
    if (rnd < .15) return d3.easeBackInOut.overshoot((0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(0.5, 3));
    else if (rnd < .3) return d3.easeElasticInOut.amplitude((0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(0.9, 1.5)).period((0, $08b51f3f4a82ba06$export$51e16a050e2bf069)(0.2, 0.4));
...
function $ba5c5d811afd797b$export$f7d3c41002dae854(infoType = null, newValue = null) {
    // valid inputs ??
    ...
    // validating.....
    const result = (0, $13e995fcd4f68ee5$export$62f74afbfe07916b)(infoType, newValue);
    if (result !== true) {
        console.log(result);
        return;
    }
...
function $ba5c5d811afd797b$export$6556b97061fcd918() {
...
function $ba5c5d811afd797b$export$fa6d0396531d5260(text = "MASTER SYSTEM DISPLAY") {
...
function $ba5c5d811afd797b$export$ba2069408edc72aa() {
    document.addEventListener("keydown", $ba5c5d811afd797b$export$66dcc3fef956cd3f, false);
}
function $ba5c5d811afd797b$export$66dcc3fef956cd3f(event) {
    // metaKey on Windows is Windows key
    // on Mac, it's the command key
    // firefox ignores meta key
    if ((event.ctrlKey || event.metaKey) && event.shiftKey && event.code === "KeyF") (0, $221d85e6cc58a701$export$a25ea78e22395c66)();
    else if (!event.ctrlKey && !event.metaKey && !event.shiftKey && event.code === "KeyM") (0, $dab718e507db4475$export$c8cdacb776d3b001)();
}
...
const $10cf9956fee6f4c6$var$CRapp = {
    userSessionSettings: (0, $13e995fcd4f68ee5$export$36c7bb024fc249a2)(),
...
$10cf9956fee6f4c6$var$CRapp.serverApiData = {
    projectRITOS: `${$10cf9956fee6f4c6$var$CRapp.buildNumber}`,
    clientUid: (0, $08b51f3f4a82ba06$export$cc4d98609e3a31e7)(7),
    alertStatus: "normal",
    colorSchemeName: "Ritos Yellow",
    themeColor: {
        r: 0,
...
$10cf9956fee6f4c6$var$CRapp.allColorCssVarNames = $10cf9956fee6f4c6$var$CRapp.primaryColorCssVarNames.concat($10cf9956fee6f4c6$var$CRapp.secondaryColorCssVarNames);
// Safari 3.0+ "[object HTMLElementConstructor]" 
$10cf9956fee6f4c6$var$CRapp.isSafari = /constructor/i.test(window.HTMLElement) || function(p) {
    return p.toString() === "[object SafariRemoteNotification]";
}(!window["safari"] || typeof safari !== "undefined" && window["safari"].pushNotification);
if ($10cf9956fee6f4c6$var$CRapp.isSafari) document.documentElement.dataset.safari = "";
function $10cf9956fee6f4c6$export$fd6634b1b91dc17e() {
    return $10cf9956fee6f4c6$var$CRapp;
}
document.body.style.backgroundColor = "#000"; // during app init, set bg to black to override user settings
(0, $13e995fcd4f68ee5$export$131c68bd6f589ff1)();
// import svg from 'bundle-text:./msd.svg';
// document.getElementById('msdContainer').innerHTML = svg;
$10cf9956fee6f4c6$var$CRapp.setPageState = (page)=>{
    // during app init, the pageState is set to 'init' manually
    if (page == "home" || page == "ship") {
        $10cf9956fee6f4c6$var$CRapp.pageState = page;
 ...
 */ const $10cf9956fee6f4c6$var$serverTimeCheck = async function() {
    const requestURL = $10cf9956fee6f4c6$var$CRapp.buildFile + "?r1=" + Math.random();
    try {
        $10cf9956fee6f4c6$var$CRapp.performanceMarkerServer = performance.now();
        const response = await fetch(requestURL, {
            method: "HEAD"
        }); // undetermined amount of time to download header
        $10cf9956fee6f4c6$var$CRapp.performanceMarkerServer = ($10cf9956fee6f4c6$var$CRapp.performanceMarkerServer + performance.now()) / 2; // use avg time -- content dl time might be long
        ...
        $10cf9956fee6f4c6$var$CRapp.serverTime = new Date(tmpStringArray[0] + "GMT"); // "date" is server time when header was created right before sending
        if ($10cf9956fee6f4c6$var$CRapp.serverTime.toString().toLowerCase() == "invalid date") {
            // use client's local date time instead
            $10cf9956fee6f4c6$var$CRapp.serverTime = undefined;
            $10cf9956fee6f4c6$var$CRapp.performanceMarkerServer = undefined;
        }
 ...
 */ const $10cf9956fee6f4c6$var$buildCheck = async function(checkImmediately = false) {
    // pre-check 
    const serverCheckMinimumWaitPeriod = 43200000; // at least a 12-hour gap before checking with server
    // console.log("======= BUILD CHECK");
    if (!checkImmediately) {
        if (performance.now() - $10cf9956fee6f4c6$var$CRapp.buildCheckLastTime < serverCheckMinimumWaitPeriod) // console.log("======= too soon to check build. Abort");
        return; // abort -- too soon to do a build check
    }
    // check build info from server
    $10cf9956fee6f4c6$var$CRapp.buildCheckLastTime = performance.now();
    const requestURL = $10cf9956fee6f4c6$var$CRapp.buildFile + "?r2=" + Math.random();
    ...
    try {
        ...
        // console.log("=== fetch Error");
        // console.log(error);
        $10cf9956fee6f4c6$var$CRapp.buildCheckLastTime -= 0.8 * serverCheckMinimumWaitPeriod; // due to error, make the next allowed server check sooner
    ...
    if (buildInfoOnServer.buildNumber > $10cf9956fee6f4c6$var$CRapp.buildNumber) location.reload();
    else try {
        localStorage.removeItem("cerritos_tmpReloadCounter");
    } catch (error2) {
        return;
...
setInterval(()=>{
    $10cf9956fee6f4c6$var$buildCheck();
}, 10800000); // every 3 hours to attempt
$10cf9956fee6f4c6$var$buildCheck(true);
/**
 ...
 */ function $10cf9956fee6f4c6$var$handleVisibilityChange() {
    if (!document.hidden) $10cf9956fee6f4c6$var$buildCheck();
}
document.addEventListener("visibilitychange", $10cf9956fee6f4c6$var$handleVisibilityChange, false);
// build check ================================================================================================
function $10cf9956fee6f4c6$var$showNewVersionNotification() {
    try {
        let lastVisitVersion = parseFloat(localStorage.getItem("projectRitos_lastVisitVersion"));
        localStorage.setItem("projectRitos_lastVisitVersion", $10cf9956fee6f4c6$var$CRapp.buildNumber);
        if (isNaN(lastVisitVersion)) return; // abort - no previous visit record found
        // ignore if version difference is minor
        if (Math.floor($10cf9956fee6f4c6$var$CRapp.buildNumber) - Math.floor(lastVisitVersion) >= 1) // show notification
...
$10cf9956fee6f4c6$var$showNewVersionNotification(); // if this version if newer than the last visited version
// RESIZE handler ==================================================
window.addEventListener("resize", function() {
    // resizing tasks & functions
    // TODO ... need to throttle this
    // TODO ... don't do resize functions if UI is not done init
    (0, $ba5c5d811afd797b$export$d7b85a0d97268c94)();
});
// run init functions
// pause to wait for webFont loading
// check if all preload assets are done
// start running the app
function $10cf9956fee6f4c6$var$sleep(ms) {
    return new Promise((resolve)=>setTimeout(resolve, ms));
}
const $10cf9956fee6f4c6$var$asyncCheckWebFontIsReady = async function() {
    ...
    for(let i = 0; i < totalWaitTime / intervalCheckTime; i++){
        await $10cf9956fee6f4c6$var$sleep(intervalCheckTime); // idle for x secs
        if (root.classList.contains("wf-active")) break; // checking font
    }
};
function $10cf9956fee6f4c6$var$startSvgPointerHit() {
    $10cf9956fee6f4c6$var$CRapp.svg1.onpointerdown = (e)=>{
        if ($10cf9956fee6f4c6$var$CRapp.pageState !== "ship" || !$10cf9956fee6f4c6$var$CRapp.shipLabelsVisible || $10cf9956fee6f4c6$var$CRapp.shipZoomMode || $10cf9956fee6f4c6$var$CRapp.shipLabelGotHit) return;
        (0, $fb2f4fe51f80d60c$export$c04e772a8363eccc)(Number(e.clientX.toFixed(0)), Number(e.clientY.toFixed(0)));
    // console.log(
...
const $10cf9956fee6f4c6$var$initApp = async function() {
    if ($10cf9956fee6f4c6$var$CRapp.debugMode) {
        ...
        window.CRapp = $10cf9956fee6f4c6$var$CRapp;
    }
    if ($10cf9956fee6f4c6$var$CRapp.serverApiConnection) console.log("%c >>>>>>> WebSocket API Connection is permitted <<<<<<< ", "color:#ff9900; background:#442200"); // debugger
    (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("System Initiating . . .", "timePrefix");
    // preloadImageAsset();
    await $10cf9956fee6f4c6$var$serverTimeCheck();
    ...
    await $10cf9956fee6f4c6$var$asyncCheckWebFontIsReady();
    $10cf9956fee6f4c6$var$CRapp.svgWidth = Number(document.querySelector("#msdContainer > svg").getAttribute("width"));
    $10cf9956fee6f4c6$var$CRapp.svgHeight = Number(document.querySelector("#msdContainer > svg").getAttribute("height"));
    // with a given pointer x y from client, return the x y that are corresponding to SVG coordinate
    $10cf9956fee6f4c6$var$CRapp.getPointerLocationOnSvg = (x, y)=>{
        // calculate svg-page resize reference
        const svgRatio = $10cf9956fee6f4c6$var$CRapp.svgWidth / $10cf9956fee6f4c6$var$CRapp.svgHeight;
        ...
        if (pageWidth / pageHeight > svgRatio) {
            svgScale = pageHeight / $10cf9956fee6f4c6$var$CRapp.svgHeight;
            svgScaledWidth = $10cf9956fee6f4c6$var$CRapp.svgWidth * svgScale;
            svgScaledHeight = pageHeight;
            svgOriginOnPageX = (pageWidth - svgScaledWidth) * .5;
            svgOriginOnPageY = 0;
        } else {
            svgScale = pageWidth / $10cf9956fee6f4c6$var$CRapp.svgWidth;
            svgScaledWidth = pageWidth;
            svgScaledHeight = $10cf9956fee6f4c6$var$CRapp.svgHeight * svgScale;
            svgOriginOnPageX = 0;
    ...
    (0, $ba5c5d811afd797b$export$b6b0e127fc71cc83)();
    // apply all session settings to app, except 'ldGlare', before server handshake
    // 'ldGlare' will be done later for intro effect
    (0, $13e995fcd4f68ee5$export$65454018d8d76fd3)("ldGlare");
    // setup fullscreen toggle
    (0, $221d85e6cc58a701$export$30d8a1cfcadf29b)();
    (0, $ba5c5d811afd797b$export$ba2069408edc72aa)(); // for fullscreen & audio mute shortcuts
    document.querySelector("#updateLog > h1").onpointerdown = function() {
        document.querySelector("#updateLog").classList.toggle("show");
        (0, $ba5c5d811afd797b$export$bdc5a3df8001f263)(this);
        (0, $dab718e507db4475$export$80cb197f7ea4fe13)("shortRandomBeep", 0, 0, 0, 0.25);
    };
// debugger
};
// ======================= EXIT INTRO, ENTER MAIN APP
const $10cf9956fee6f4c6$var$mainApp = function() {
    // exit intro
    // show main app
    ...
    setTimeout(()=>{
        ...
        if (document.documentElement.dataset.about !== "show") {
            // close about
            (0, $ba5c5d811afd797b$export$44ae1f4c32a29f68)("mute");
            setTimeout(()=>{
                ...
                $10cf9956fee6f4c6$var$CRapp.stopStartUpAudioContextListener();
                $10cf9956fee6f4c6$var$CRapp.resumeAudioContext = null;
                $10cf9956fee6f4c6$var$CRapp.stopStartUpAudioContextListener = null;
                delete $10cf9956fee6f4c6$var$CRapp.resumeAudioContext;
                delete $10cf9956fee6f4c6$var$CRapp.stopStartUpAudioContextListener;
        ...
        setTimeout(()=>{
            ...
            (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("BUILD VERSION " + $10cf9956fee6f4c6$var$CRapp.revisionDate);
            // toggleGlare(null, 'noLog', 'mute');
            if ($10cf9956fee6f4c6$var$CRapp.userSessionSettings.ldGlare) (0, $ba5c5d811afd797b$export$4a4f808287652e93)(true, "noLog", "mute");
            ...
            setTimeout(()=>{
                // * show header
                (0, $dab718e507db4475$export$80cb197f7ea4fe13)("powerUp");
                document.querySelector("#msdContainer > svg #frameHeader").style.opacity = 1;
            }, 500);
        }, 600);
        setTimeout(()=>{
            (0, $4024e26eb017430a$export$57f76693a5823e7b)();
            // document.querySelector('#msdContainer > svg #frameHeader').style.opacity = .6;
            (0, $ba5c5d811afd797b$export$915e86dc1242cd73)("Loading LD LCARS . . .", "timePrefix");
        }, 1800);
        // start up random log generator
        (0, $ba5c5d811afd797b$export$5757c822a6ab549a)();
        (0, $fe3d05c3bcaea3ea$export$3851b34a6f183e48)(); // ! <<<<<<<<<<<<<<<<<<<<<<<<
    }, 3000); //* <<<<<<< All preloads done. Make user wait on intro screen
    setTimeout(()=>{
        $10cf9956fee6f4c6$var$startSvgPointerHit();
    }, 6000); // delay start
};
window.stopAllShipAnimations = (0, $6fdf0ffb4a84c329$export$8a2e6fed9df8c3ad); // ! <<<<<<<<<<<< ???????
function $10cf9956fee6f4c6$export$9ae4d28a04c72663(imgIndex = null) {
    if (imgIndex == null) return false;
    if ($10cf9956fee6f4c6$var$CRapp.jwstImg.filePreloaded[imgIndex]) return true;
    return false;
}
function $10cf9956fee6f4c6$var$jwstImgPreloadCallback(e) {
    const preloadedImgIndex = parseInt(e.currentTarget.dataset.jwstImgIndex);
    $10cf9956fee6f4c6$var$CRapp.jwstImg.filePreloaded[preloadedImgIndex] = true;
    $10cf9956fee6f4c6$var$CRapp.jwstImg.preloadedIndexes.push(preloadedImgIndex);
}
function $10cf9956fee6f4c6$export$4ab67db1ad2f21ae(newImgIndex = null) {
    if (newImgIndex == null) return false;
    if ($10cf9956fee6f4c6$var$CRapp.jwstImg.filePreloaded[newImgIndex] == true) return; // no need to preload again
    const tempImage = new Image();
    tempImage.dataset.jwstImgIndex = newImgIndex;
    tempImage.addEventListener("load", $10cf9956fee6f4c6$var$jwstImgPreloadCallback, true); // preload callback event
    tempImage.src = $10cf9956fee6f4c6$var$CRapp.jwstImg.fileRef[newImgIndex]; // loading it....
}
// pick a random image for the next jwst cycle, and preloading it
$10cf9956fee6f4c6$var$CRapp.jwstNextImgIndex = (0, $08b51f3f4a82ba06$export$3c5f89dae98e900b)($10cf9956fee6f4c6$var$CRapp.jwstImg.fileRef.length);
$10cf9956fee6f4c6$export$4ab67db1ad2f21ae($10cf9956fee6f4c6$var$CRapp.jwstNextImgIndex);
(0, $dab718e507db4475$export$3d7e390f2650e949)();
let $10cf9956fee6f4c6$var$assetPreloaded = false;
function $10cf9956fee6f4c6$var$checkAssetPreloadProgress() {
    // add other future asset type preloads checking here
    if ($10cf9956fee6f4c6$export$9ae4d28a04c72663($10cf9956fee6f4c6$var$CRapp.jwstNextImgIndex) && $10cf9956fee6f4c6$var$CRapp.sounds.assetReady) $10cf9956fee6f4c6$var$assetPreloaded = true;
}
let $10cf9956fee6f4c6$var$pageReadyState_interval = setInterval(function() {
    $10cf9956fee6f4c6$var$checkAssetPreloadProgress();
    if (document.readyState === "complete" && $10cf9956fee6f4c6$var$assetPreloaded) {
        // all sub resources + preloadAssets have all been loaded
        clearInterval($10cf9956fee6f4c6$var$pageReadyState_interval);
        $10cf9956fee6f4c6$var$initApp().then(()=>{
            $10cf9956fee6f4c6$var$mainApp();
        });
    }
}, 800);
